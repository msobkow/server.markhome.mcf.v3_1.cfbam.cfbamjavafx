// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash224Gen.
...
/**
 *	CFBamJavaFXDbKeyHash224GenAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamJavaFXDbKeyHash224GenAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash224GenPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash224GenObj cur = getJavaFXFocusAsDbKeyHash224Gen();
				if( cur != null ) {
					ICFBamDbKeyHash224GenEditObj editObj = (ICFBamDbKeyHash224GenEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash224GenObj focus = getEffJavaFXFocus();
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash224Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 56 );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash224Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash224Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamDbKeyHash224Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash224Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash224Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash224Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamDbKeyHash224Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash224Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash224Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
	...
	public CFBamJavaFXDbKeyHash224GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsDbKeyHash224Gen( argFocus );
	...
	public ICFBamDbKeyHash224GenObj getEffJavaFXFocus() {
		ICFBamDbKeyHash224GenObj eff = (ICFBamDbKeyHash224GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash224GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash224GenObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash224GenObj focus = getJavaFXFocusAsDbKeyHash224Gen();
		ICFBamDbKeyHash224GenEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash224GenEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash224GenEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash224GenObj)editObj.create();
