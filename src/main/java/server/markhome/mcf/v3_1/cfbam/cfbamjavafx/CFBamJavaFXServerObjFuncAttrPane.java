// Description: Java 25 JavaFX Attribute Pane implementation for ServerObjFunc.
...
implements ICFBamJavaFXServerObjFuncPaneCommon
{
		...
		extends CFLabel
	{
		public RetTableCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.ServerObjFunc.AttrPane.LookupRetTable.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public RetTableCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.ServerObjFunc.AttrPane.RetTable.EffLabel" );
		}
	}
