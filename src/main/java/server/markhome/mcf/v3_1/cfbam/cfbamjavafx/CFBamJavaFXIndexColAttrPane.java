// Description: Java 25 JavaFX Attribute Pane implementation for IndexCol.
...
implements ICFBamJavaFXIndexColPaneCommon
{
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ColumnCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.LookupColumn.EffLabel"));
		}
	}
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			if( refIndex == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.IndexCol.AttrPane.ContainerIndex.EffLabel"), Inz.s("cfbam.javafx.IndexCol.AttrPane.LookupColumn.EffLabel")));
				return;
			}
			ICFBamTableObj refTable = refIndex.getRequiredContainerTable( javafxIsInitializing );
			if( refTable == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.Index.AttrPane.ContainerTable.EffLabel"), Inz.s("cfbam.javafx.IndexCol.AttrPane.LookupColumn.EffLabel")));
				return;
			}
		...
		extends CFReferenceEditor
	{
		public ColumnCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.Column.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortNameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.ShortName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortNameEditor() {
			super();
			setMaxLen( 16 );
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.ShortName.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public LabelCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.Label.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public LabelEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.Label.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortDescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.ShortDescription.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortDescriptionEditor() {
			super();
			setMaxLen( 128 );
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.ShortDescription.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 1023 );
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.Description.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsAscendingCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.IndexCol.AttrPane.IsAscending.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsAscendingEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfbam.javafx.IndexCol.AttrPane.IsAscending.EffLabel" );
		}
	}
