// Description: Java 25 JavaFX View/Edit Pane implementation for Tweak.
...
/**
 *	CFBamJavaFXTweakViewEditPane JavaFX View/Edit Pane implementation
 *	for Tweak.
 */
public class CFBamJavaFXTweakViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTweakPaneCommon
{
	...
	public CFBamJavaFXTweakViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTweakObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTweakPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
