// Description: Java 25 JavaFX Add Form implementation for DbKeyHash384Def.
...
/**
 *	CFBamJavaFXDbKeyHash384DefAddForm JavaFX Add Form implementation
 *	for DbKeyHash384Def.
 */
public class CFBamJavaFXDbKeyHash384DefAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash384Def";
	...
	public CFBamJavaFXDbKeyHash384DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash384DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash384DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash384DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash384DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash384DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
