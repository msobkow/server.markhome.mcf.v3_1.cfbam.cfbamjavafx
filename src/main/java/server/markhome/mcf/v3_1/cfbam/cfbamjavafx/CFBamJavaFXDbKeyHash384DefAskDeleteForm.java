// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash384Def.
...
/**
 *	CFBamJavaFXDbKeyHash384DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash384Def.
 */
public class CFBamJavaFXDbKeyHash384DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash384Def";
	...
	public CFBamJavaFXDbKeyHash384DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash384Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash384DefObj obj = getJavaFXFocusAsDbKeyHash384Def();
					ICFBamDbKeyHash384DefEditObj editObj = (ICFBamDbKeyHash384DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash384DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash384Def( ICFBamDbKeyHash384DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash384DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash384DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
