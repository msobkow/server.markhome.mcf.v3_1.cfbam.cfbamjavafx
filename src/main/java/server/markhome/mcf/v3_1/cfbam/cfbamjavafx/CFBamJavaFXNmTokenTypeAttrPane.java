// Description: Java 25 JavaFX Attribute Pane implementation for NmTokenType.
...
implements ICFBamJavaFXNmTokenTypePaneCommon
{
		...
		extends CFLabel
	{
		public MaxLenCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NmTokenDef.AttrPane.MaxLen.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxLenEditor() {
			super();
			setMinValue( ICFBamNmTokenDef.MAXLEN_MIN_VALUE );
			setMaxValue( ICFBamNmTokenDef.MAXLEN_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.NmTokenDef.AttrPane.MaxLen.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NmTokenDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFNmTokenEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.NmTokenDef.AttrPane.InitValue.EffLabel" );
		}
	}
