// Description: Java 25 JavaFX View/Edit Pane implementation for DbKeyHash160Col.
...
/**
 *	CFBamJavaFXDbKeyHash160ColViewEditPane JavaFX View/Edit Pane implementation
 *	for DbKeyHash160Col.
 */
public class CFBamJavaFXDbKeyHash160ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash160ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160ColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getDbKeyHash160ColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
