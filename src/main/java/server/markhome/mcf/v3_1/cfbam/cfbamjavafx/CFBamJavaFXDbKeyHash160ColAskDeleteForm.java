// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash160Col.
...
/**
 *	CFBamJavaFXDbKeyHash160ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash160Col.
 */
public class CFBamJavaFXDbKeyHash160ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash160ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash160Col";
	...
	public CFBamJavaFXDbKeyHash160ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash160Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash160ColObj obj = getJavaFXFocusAsDbKeyHash160Col();
					ICFBamDbKeyHash160ColEditObj editObj = (ICFBamDbKeyHash160ColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash160ColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash160Col( ICFBamDbKeyHash160ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
