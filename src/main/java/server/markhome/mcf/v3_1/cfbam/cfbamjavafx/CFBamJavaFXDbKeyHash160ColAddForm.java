// Description: Java 25 JavaFX Add Form implementation for DbKeyHash160Col.
...
/**
 *	CFBamJavaFXDbKeyHash160ColAddForm JavaFX Add Form implementation
 *	for DbKeyHash160Col.
 */
public class CFBamJavaFXDbKeyHash160ColAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash160ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash160Col";
	...
	public CFBamJavaFXDbKeyHash160ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash160ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash160ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash160ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
