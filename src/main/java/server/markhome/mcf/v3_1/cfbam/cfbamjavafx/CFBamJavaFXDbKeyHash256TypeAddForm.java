// Description: Java 25 JavaFX Add Form implementation for DbKeyHash256Type.
...
/**
 *	CFBamJavaFXDbKeyHash256TypeAddForm JavaFX Add Form implementation
 *	for DbKeyHash256Type.
 */
public class CFBamJavaFXDbKeyHash256TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash256Type";
	...
	public CFBamJavaFXDbKeyHash256TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash256TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash256TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash256TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash256TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash256TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
