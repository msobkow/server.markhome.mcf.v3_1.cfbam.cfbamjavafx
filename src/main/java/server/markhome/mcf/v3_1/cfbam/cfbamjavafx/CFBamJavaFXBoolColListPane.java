// Description: Java 25 JavaFX List of Obj Pane implementation for BoolCol.
...
implements ICFBamJavaFXBoolColPaneList
{
	...
	protected TableColumn<ICFBamBoolColObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamBoolColObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamBoolColObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamBoolColObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamBoolColObj,CFLibDbKeyHash256>,TableCell<ICFBamBoolColObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamBoolColObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamBoolColObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamBoolColObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamBoolCol.CLASS_CODE ) {
