// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash224Def.
...
/**
 *	CFBamJavaFXDbKeyHash224DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash224Def.
 */
public class CFBamJavaFXDbKeyHash224DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash224DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash224Def";
	...
	public CFBamJavaFXDbKeyHash224DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash224Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash224DefObj obj = getJavaFXFocusAsDbKeyHash224Def();
					ICFBamDbKeyHash224DefEditObj editObj = (ICFBamDbKeyHash224DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash224DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash224Def( ICFBamDbKeyHash224DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash224DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash224DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
