// Description: Java 25 JavaFX Attribute Pane implementation for ServerListFunc.
...
implements ICFBamJavaFXServerListFuncPaneCommon
{
		...
		extends CFLabel
	{
		public RetTableCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.ServerListFunc.AttrPane.LookupRetTable.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public RetTableCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.ServerListFunc.AttrPane.RetTable.EffLabel" );
		}
	}
