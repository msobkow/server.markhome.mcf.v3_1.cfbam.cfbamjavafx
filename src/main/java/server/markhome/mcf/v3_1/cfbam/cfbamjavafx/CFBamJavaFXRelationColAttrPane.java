// Description: Java 25 JavaFX Attribute Pane implementation for RelationCol.
...
implements ICFBamJavaFXRelationColPaneCommon
{
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public LookupFromColCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupFromCol.EffLabel"));
		}
	}
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			if( refRelation == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.RelationCol.AttrPane.ContainerRelation.EffLabel"), Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupFromCol.EffLabel")));
				return;
			}
			ICFBamIndexObj refFromIndex = refRelation.getRequiredLookupFromIndex( javafxIsInitializing );
			if( refFromIndex == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.Relation.AttrPane.LookupFromIndex.EffLabel"), Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupFromCol.EffLabel")));
				return;
			}
		...
		public void view( ICFLibAnyObj value ) {
			...
			if( focus != null ) {
				...
				if( referencedObj != null ) {
					...
					ICFSecSchema.ClassMapEntry entry = ICFBamSchema.getClassMapByRuntimeClassCode(classCode);
					int backingClassCode = entry.getBackingClassCode();
					if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamIndexCol.CLASS_CODE ) {
		...
		extends CFReferenceEditor
	{
		public LookupFromColCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.LookupFromCol.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public LookupToColCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupToCol.EffLabel"));
		}
	}
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamRelationObj refRelation = (ICFBamRelationObj)focus.getRequiredContainerRelation( javafxIsInitializing );
			if( refRelation == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.RelationCol.AttrPane.ContainerRelation.EffLabel"), Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupToCol.EffLabel")));
				return;
			}
			ICFBamIndexObj refToIndex = refRelation.getRequiredLookupToIndex( javafxIsInitializing );
			if( refToIndex == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.Relation.AttrPane.LookupToIndex.EffLabel"), Inz.s("cfbam.javafx.RelationCol.AttrPane.LookupToCol.EffLabel")));
				return;
			}
		...
		extends CFReferenceEditor
	{
		public LookupToColCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.LookupToCol.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortNameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.ShortName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortNameEditor() {
			super();
			setMaxLen( 16 );
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.ShortName.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public LabelCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.Label.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public LabelEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.Label.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortDescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.ShortDescription.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortDescriptionEditor() {
			super();
			setMaxLen( 128 );
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.ShortDescription.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RelationCol.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 1023 );
			setFieldNameInzTag( "cfbam.javafx.RelationCol.AttrPane.Description.EffLabel" );
		}
	}
