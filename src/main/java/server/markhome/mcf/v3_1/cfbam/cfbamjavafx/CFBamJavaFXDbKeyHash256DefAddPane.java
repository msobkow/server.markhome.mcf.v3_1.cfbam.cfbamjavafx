// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash256Def.
...
/**
 *	CFBamJavaFXDbKeyHash256DefAddPane JavaFX Add Pane implementation
 *	for DbKeyHash256Def.
 */
public class CFBamJavaFXDbKeyHash256DefAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash256DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash256DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
