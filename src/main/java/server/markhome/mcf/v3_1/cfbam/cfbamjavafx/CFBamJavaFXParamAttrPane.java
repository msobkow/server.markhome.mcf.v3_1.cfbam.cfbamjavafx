...
implements ICFBamJavaFXParamPaneCommon
{
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public TypeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.LookupType.EffLabel"));
		}
	}
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			if( refServerMeth == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.Param.AttrPane.ContainerServerMeth.EffLabel"), Inz.s("cfbam.javafx.Param.AttrPane.LookupType.EffLabel")));
				return;
			}
			ICFBamTableObj refForTable = refServerMeth.getRequiredContainerForTable( javafxIsInitializing );
			if( refForTable == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.ServerMethod.AttrPane.ContainerForTable.EffLabel"), Inz.s("cfbam.javafx.Param.AttrPane.LookupType.EffLabel")));
				return;
			}
			ICFBamSchemaDefObj refSchemaDef = refForTable.getRequiredContainerSchemaDef( javafxIsInitializing );
			if( refSchemaDef == null ) {
				CFConsole.message( String.format(Inz.s("cflibjavafx.common.SpecifyRelationBeforeSelectingTarget"), Inz.s("cfbam.javafx.Table.AttrPane.ContainerSchemaDef.EffLabel"), Inz.s("cfbam.javafx.Param.AttrPane.LookupType.EffLabel")));
				return;
			}
		...
		extends CFReferenceEditor
	{
		public TypeCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.Type.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortDescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.ShortDescription.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortDescriptionEditor() {
			super();
			setMaxLen( 128 );
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.ShortDescription.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 1023 );
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.Description.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsNullableCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Param.AttrPane.IsNullable.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsNullableEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfbam.javafx.Param.AttrPane.IsNullable.EffLabel" );
		}
	}
