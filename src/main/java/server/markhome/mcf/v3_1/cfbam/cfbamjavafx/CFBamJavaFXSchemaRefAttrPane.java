...
implements ICFBamJavaFXSchemaRefPaneCommon
{
		...
		extends CFLabel
	{
		public RefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.SchemaRef.AttrPane.LookupRefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public RefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.SchemaRef.AttrPane.RefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.SchemaRef.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.SchemaRef.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public RefModelNameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.SchemaRef.AttrPane.RefModelName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public RefModelNameEditor() {
			super();
			setMaxLen( 1024 );
			setFieldNameInzTag( "cfbam.javafx.SchemaRef.AttrPane.RefModelName.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IncludeRootCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.SchemaRef.AttrPane.IncludeRoot.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public IncludeRootEditor() {
			super();
			setMaxLen( 1024 );
			setFieldNameInzTag( "cfbam.javafx.SchemaRef.AttrPane.IncludeRoot.EffLabel" );
		}
	}
