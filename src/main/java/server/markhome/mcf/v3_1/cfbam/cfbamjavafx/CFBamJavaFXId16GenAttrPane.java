// Description: Java 25 JavaFX Attribute Pane implementation for Id16Gen.
...
implements ICFBamJavaFXId16GenPaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int16Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamInt16Def.INITVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt16Def.INITVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int16Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int16Def.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamInt16Def.MINVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt16Def.MINVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int16Def.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int16Def.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamInt16Def.MAXVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt16Def.MAXVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int16Def.AttrPane.MaxValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Id16Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamId16Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamId16Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Id16Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Id16Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamId16Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamId16Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Id16Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
