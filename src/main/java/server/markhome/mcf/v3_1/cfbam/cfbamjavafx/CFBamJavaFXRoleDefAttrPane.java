// Description: Java 25 JavaFX Attribute Pane implementation for RoleDef.
...
/**
 *	CFBamJavaFXRoleDefAttrPane JavaFX Attribute Pane implementation
 *	for RoleDef.
 */
public class CFBamJavaFXRoleDefAttrPane
extends CFGridPane
implements ICFBamJavaFXRoleDefPaneCommon
{
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RoleDef.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamRoleDefObj cur = getJavaFXFocusAsRoleDef();
				if( cur != null ) {
					ICFBamRoleDefEditObj editObj = (ICFBamRoleDefEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamRoleDefObj focus = getEffJavaFXFocus();
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.RoleDef.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RoleDef.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfbam.javafx.RoleDef.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.RoleDef.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.RoleDef.AttrPane.Name.EffLabel" );
		}
	}
	...
	public CFBamJavaFXRoleDefAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRoleDefObj argFocus ) {
		...
		setJavaFXFocusAsRoleDef( argFocus );
	...
	public ICFBamRoleDefObj getEffJavaFXFocus() {
		ICFBamRoleDefObj eff = (ICFBamRoleDefObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamRoleDefObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamRoleDefObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamRoleDefObj focus = getJavaFXFocusAsRoleDef();
		ICFBamRoleDefEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamRoleDefEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamRoleDefEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamRoleDefObj)editObj.create();
