// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash256Gen.
...
/**
 *	CFBamJavaFXDbKeyHash256GenAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamJavaFXDbKeyHash256GenAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash256GenPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash256GenObj cur = getJavaFXFocusAsDbKeyHash256Gen();
				if( cur != null ) {
					ICFBamDbKeyHash256GenEditObj editObj = (ICFBamDbKeyHash256GenEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash256GenObj focus = getEffJavaFXFocus();
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash256Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash256Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash256Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamDbKeyHash256Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash256Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash256Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash256Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamDbKeyHash256Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash256Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash256Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
	...
	public CFBamJavaFXDbKeyHash256GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsDbKeyHash256Gen( argFocus );
	...
	public ICFBamDbKeyHash256GenObj getEffJavaFXFocus() {
		ICFBamDbKeyHash256GenObj eff = (ICFBamDbKeyHash256GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash256GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash256GenObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash256GenObj focus = getJavaFXFocusAsDbKeyHash256Gen();
		ICFBamDbKeyHash256GenEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash256GenEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash256GenEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash256GenObj)editObj.create();
