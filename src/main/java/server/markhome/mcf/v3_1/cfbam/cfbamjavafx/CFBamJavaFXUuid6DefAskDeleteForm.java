// Description: Java 25 JavaFX Ask Delete Pane implementation for Uuid6Def.
...
/**
 *	CFBamJavaFXUuid6DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Uuid6Def.
 */
public class CFBamJavaFXUuid6DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuid6DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Uuid6Def";
	...
	public CFBamJavaFXUuid6DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Uuid6Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuid6DefObj obj = getJavaFXFocusAsUuid6Def();
					ICFBamUuid6DefEditObj editObj = (ICFBamUuid6DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getUuid6DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsUuid6Def( ICFBamUuid6DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuid6DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUuid6DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
