// Description: Java 25 JavaFX Add Form implementation for DbKeyHash512Type.
...
/**
 *	CFBamJavaFXDbKeyHash512TypeAddForm JavaFX Add Form implementation
 *	for DbKeyHash512Type.
 */
public class CFBamJavaFXDbKeyHash512TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash512Type";
	...
	public CFBamJavaFXDbKeyHash512TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash512TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash512TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
