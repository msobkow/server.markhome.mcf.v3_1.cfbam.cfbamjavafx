// Description: Java 25 JavaFX Ask Delete Pane implementation for TableTweak.
...
/**
 *	CFBamJavaFXTableTweakAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TableTweak.
 */
public class CFBamJavaFXTableTweakAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTableTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TableTweak";
	...
	public CFBamJavaFXTableTweakAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableTweakObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TableTweak?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTableTweakObj obj = getJavaFXFocusAsTableTweak();
					ICFBamTableTweakEditObj editObj = (ICFBamTableTweakEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTableTweakFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTableTweak( ICFBamTableTweakObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTableTweakPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTableTweakPaneCommon)attrPane).setPaneMode( value );
		}
	}
