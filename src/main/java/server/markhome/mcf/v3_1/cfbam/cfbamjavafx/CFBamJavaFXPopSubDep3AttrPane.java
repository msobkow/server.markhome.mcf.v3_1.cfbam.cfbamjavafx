// Description: Java 25 JavaFX Attribute Pane implementation for PopSubDep3.
...
implements ICFBamJavaFXPopSubDep3PaneCommon
{
		...
		extends CFLabel
	{
		public RelationCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.PopDep.AttrPane.LookupRelation.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public RelationCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.PopDep.AttrPane.Relation.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.PopDep.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.PopDep.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.PopSubDep3.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.PopSubDep3.AttrPane.Name.EffLabel" );
		}
	}
