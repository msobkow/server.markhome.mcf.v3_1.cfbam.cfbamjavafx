// Description: Java 25 JavaFX Ask Delete Pane implementation for SchemaRole.
...
/**
 *	CFBamJavaFXSchemaRoleAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SchemaRole.
 */
public class CFBamJavaFXSchemaRoleAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXSchemaRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete SchemaRole";
	...
	public CFBamJavaFXSchemaRoleAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRoleObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this SchemaRole?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamSchemaRoleObj obj = getJavaFXFocusAsSchemaRole();
					ICFBamSchemaRoleEditObj editObj = (ICFBamSchemaRoleEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSchemaRoleFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSchemaRole( ICFBamSchemaRoleObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaRolePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaRolePaneCommon)attrPane).setPaneMode( value );
		}
	}
