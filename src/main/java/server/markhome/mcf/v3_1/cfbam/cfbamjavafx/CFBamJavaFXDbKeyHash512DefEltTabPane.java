// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash512Def.
...
/**
 *	CFBamJavaFXDbKeyHash512DefEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash512Def.
 */
public class CFBamJavaFXDbKeyHash512DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash512DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash512DefObj focus = (ICFBamDbKeyHash512DefObj)getJavaFXFocusAsDbKeyHash512Def();
			if( focus != null ) {
