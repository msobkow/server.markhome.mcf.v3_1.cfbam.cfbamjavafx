// Description: Java 25 JavaFX Attribute Pane implementation for UInt32Type.
...
implements ICFBamJavaFXUInt32TypePaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt32Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFUInt32Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamUInt32Def.INITVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt32Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt32Def.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFUInt32Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamUInt32Def.MINVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt32Def.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt32Def.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFUInt32Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamUInt32Def.MAXVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt32Def.AttrPane.MaxValue.EffLabel" );
		}
	}
