// Description: Java 25 JavaFX Attribute Pane implementation for ClearSubDep3.
...
implements ICFBamJavaFXClearSubDep3PaneCommon
{
		...
		extends CFLabel
	{
		public RelationCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.ClearDep.AttrPane.LookupRelation.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public RelationCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.ClearDep.AttrPane.Relation.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.ClearDep.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.ClearDep.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.ClearSubDep3.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.ClearSubDep3.AttrPane.Name.EffLabel" );
		}
	}
