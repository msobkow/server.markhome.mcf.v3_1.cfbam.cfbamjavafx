// Description: Java 25 JavaFX Add Form implementation for DbKeyHash512Def.
...
/**
 *	CFBamJavaFXDbKeyHash512DefAddForm JavaFX Add Form implementation
 *	for DbKeyHash512Def.
 */
public class CFBamJavaFXDbKeyHash512DefAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash512Def";
	...
	public CFBamJavaFXDbKeyHash512DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash512DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash512DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash512DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash512DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
