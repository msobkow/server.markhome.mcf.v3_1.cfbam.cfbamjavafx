// Description: Java 25 JavaFX Attribute Pane implementation for TimestampType.
...
implements ICFBamJavaFXTimestampTypePaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TimestampDef.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 4 );
			setFieldNameInzTag( "cfbam.javafx.TimestampDef.AttrPane.Dummy.EffLabel" );
		}
	}
