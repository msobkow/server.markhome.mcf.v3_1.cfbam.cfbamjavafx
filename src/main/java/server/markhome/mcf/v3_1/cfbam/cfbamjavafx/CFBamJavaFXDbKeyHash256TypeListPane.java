// Description: Java 25 JavaFX List of Obj Pane implementation for DbKeyHash256Type.
...
/**
 *	CFBamJavaFXDbKeyHash256TypeListPane JavaFX List of Obj Pane implementation
 *	for DbKeyHash256Type.
 */
public class CFBamJavaFXDbKeyHash256TypeListPane
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256TypePaneList
{
	public static String S_FormName = "List DbKeyHash256Type";
	...
	public CFBamJavaFXDbKeyHash256TypeListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		...
		if( observableListOfDbKeyHash256Type != null ) {
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash256Type.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getDbKeyHash256TypeFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
								...
								throw new CFLibUnsupportedClassException( getClass(),
									...
									"selectedInstance",
									selectedInstance,
									"ICFBamDbKeyHash256TypeObj, ICFBamDbKeyHash256GenObj" );
							}
						}
					}
					catch( Throwable t ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash256Type.CLASS_CODE ) {
								...
								ICFBamDbKeyHash256GenObj obj = (ICFBamDbKeyHash256GenObj)selectedInstance;
								CFBorderPane frame = javafxSchema.getDbKeyHash256GenFactory().newViewEditForm( cfFormManager, obj, getViewEditClosedCallback(), false );
								((ICFBamJavaFXDbKeyHash256GenPaneCommon)frame).setPaneMode( CFPane.PaneMode.Edit );
								cfFormManager.pushForm( frame );
							}
							else {
								throw new CFLibUnsupportedClassException( getClass(),
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							int backingClassCode = entry.getBackingClassCode();
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash256Type.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getDbKeyHash256TypeFactory().newAskDeleteForm( cfFormManager, selectedInstance, getDeleteCallback() );
								((ICFBamJavaFXDbKeyHash256TypePaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash256Gen.CLASS_CODE ) {
	...
	public void adjustListButtons() {
		...
		if( buttonAddDbKeyHash256Type != null ) {
			buttonAddDbKeyHash256Type.setDisable( ! allowAdds );
		}
