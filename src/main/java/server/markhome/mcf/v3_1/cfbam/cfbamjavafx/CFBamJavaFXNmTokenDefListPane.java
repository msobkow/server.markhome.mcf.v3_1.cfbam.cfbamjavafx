// Description: Java 25 JavaFX List of Obj Pane implementation for NmTokenDef.
...
implements ICFBamJavaFXNmTokenDefPaneList
{
	...
	protected TableColumn<ICFBamNmTokenDefObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamNmTokenDefObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamNmTokenDefObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamNmTokenDefObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamNmTokenDefObj,CFLibDbKeyHash256>,TableCell<ICFBamNmTokenDefObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamNmTokenDefObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamNmTokenDefObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamNmTokenDefObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamNmTokenDef.CLASS_CODE ) {
