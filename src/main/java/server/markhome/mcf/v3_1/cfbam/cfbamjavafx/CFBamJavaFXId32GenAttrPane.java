// Description: Java 25 JavaFX Attribute Pane implementation for Id32Gen.
...
implements ICFBamJavaFXId32GenPaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int32Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamInt32Def.INITVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt32Def.INITVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int32Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int32Def.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamInt32Def.MINVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt32Def.MINVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int32Def.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int32Def.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamInt32Def.MAXVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt32Def.MAXVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int32Def.AttrPane.MaxValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Id32Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamId32Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamId32Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Id32Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Id32Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamId32Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamId32Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Id32Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
