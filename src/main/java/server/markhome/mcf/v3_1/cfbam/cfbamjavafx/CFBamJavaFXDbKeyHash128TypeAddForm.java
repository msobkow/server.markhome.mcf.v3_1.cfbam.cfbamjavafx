// Description: Java 25 JavaFX Add Form implementation for DbKeyHash128Type.
...
/**
 *	CFBamJavaFXDbKeyHash128TypeAddForm JavaFX Add Form implementation
 *	for DbKeyHash128Type.
 */
public class CFBamJavaFXDbKeyHash128TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash128Type";
	...
	public CFBamJavaFXDbKeyHash128TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash128TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash128TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash128TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash128TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash128TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
