// Description: Java 25 JavaFX Element TabPane implementation for Uuid6Type.
...
/**
 *	CFBamJavaFXUuid6TypeEltTabPane JavaFX Element TabPane implementation
 *	for Uuid6Type.
 */
public class CFBamJavaFXUuid6TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuid6TypePaneCommon
{
	...
	public CFBamJavaFXUuid6TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuid6TypeObj focus = (ICFBamUuid6TypeObj)getJavaFXFocusAsUuid6Type();
			if( focus != null ) {
