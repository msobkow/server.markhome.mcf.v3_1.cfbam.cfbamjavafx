// Description: Java 25 JavaFX Add Form implementation for SchemaRole.
...
/**
 *	CFBamJavaFXSchemaRoleAddForm JavaFX Add Form implementation
 *	for SchemaRole.
 */
public class CFBamJavaFXSchemaRoleAddForm
extends CFBorderPane
implements ICFBamJavaFXSchemaRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add SchemaRole";
	...
	public CFBamJavaFXSchemaRoleAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSchemaRoleFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXSchemaRolePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSchemaRoleFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaRolePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXSchemaRolePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
