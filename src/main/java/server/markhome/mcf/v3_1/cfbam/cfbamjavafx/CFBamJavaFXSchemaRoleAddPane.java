// Description: Java 25 JavaFX Add Pane implementation for SchemaRole.
...
/**
 *	CFBamJavaFXSchemaRoleAddPane JavaFX Add Pane implementation
 *	for SchemaRole.
 */
public class CFBamJavaFXSchemaRoleAddPane
extends CFSplitPane
implements ICFBamJavaFXSchemaRolePaneCommon
{
	...
	public CFBamJavaFXSchemaRoleAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRoleObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaRolePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
