// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash512Gen.
...
/**
 *	CFBamJavaFXDbKeyHash512GenAddPane JavaFX Add Pane implementation
 *	for DbKeyHash512Gen.
 */
public class CFBamJavaFXDbKeyHash512GenAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash512GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
