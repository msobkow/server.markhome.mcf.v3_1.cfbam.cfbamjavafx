// Description: Java 25 JavaFX Picker of Obj Pane implementation for DbKeyHash128Type.
...
/**
 *	CFBamJavaFXDbKeyHash128TypePickerPane JavaFX Pick Obj Pane implementation
 *	for DbKeyHash128Type.
 */
public class CFBamJavaFXDbKeyHash128TypePickerPane
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128TypePaneList
{
	public static String S_FormName = "Choose DbKeyHash128Type";
	...
	protected ICFBamJavaFXDbKeyHash128TypeChosen invokeWhenChosen = null;
	protected ICFBamSchemaDefObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXDbKeyHash128TypePickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseDbKeyHash128Type( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseDbKeyHash128Type( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
