// Description: Java 25 JavaFX Add Form implementation for SchemaTweak.
...
/**
 *	CFBamJavaFXSchemaTweakAddForm JavaFX Add Form implementation
 *	for SchemaTweak.
 */
public class CFBamJavaFXSchemaTweakAddForm
extends CFBorderPane
implements ICFBamJavaFXSchemaTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add SchemaTweak";
	...
	public CFBamJavaFXSchemaTweakAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaTweakObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSchemaTweakFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXSchemaTweakPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSchemaTweakFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaTweakPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXSchemaTweakPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
