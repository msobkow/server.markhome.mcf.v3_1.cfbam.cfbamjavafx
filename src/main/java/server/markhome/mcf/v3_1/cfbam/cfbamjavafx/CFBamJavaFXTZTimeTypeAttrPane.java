// Description: Java 25 JavaFX Attribute Pane implementation for TZTimeType.
...
implements ICFBamJavaFXTZTimeTypePaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TZTimeDef.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 4 );
			setFieldNameInzTag( "cfbam.javafx.TZTimeDef.AttrPane.Dummy.EffLabel" );
		}
	}
