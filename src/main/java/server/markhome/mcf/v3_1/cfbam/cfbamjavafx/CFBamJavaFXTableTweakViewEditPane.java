// Description: Java 25 JavaFX View/Edit Pane implementation for TableTweak.
...
/**
 *	CFBamJavaFXTableTweakViewEditPane JavaFX View/Edit Pane implementation
 *	for TableTweak.
 */
public class CFBamJavaFXTableTweakViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTableTweakPaneCommon
{
	...
	public CFBamJavaFXTableTweakViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableTweakObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTableTweakPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
