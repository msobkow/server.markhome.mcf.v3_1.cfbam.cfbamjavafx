// Description: Java 25 JavaFX Add Form implementation for DbKeyHash256Def.
...
/**
 *	CFBamJavaFXDbKeyHash256DefAddForm JavaFX Add Form implementation
 *	for DbKeyHash256Def.
 */
public class CFBamJavaFXDbKeyHash256DefAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash256Def";
	...
	public CFBamJavaFXDbKeyHash256DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash256DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash256DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash256DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash256DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash256DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
