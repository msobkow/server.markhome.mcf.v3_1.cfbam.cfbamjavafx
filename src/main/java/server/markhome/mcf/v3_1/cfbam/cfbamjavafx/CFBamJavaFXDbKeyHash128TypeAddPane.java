// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash128Type.
...
/**
 *	CFBamJavaFXDbKeyHash128TypeAddPane JavaFX Add Pane implementation
 *	for DbKeyHash128Type.
 */
public class CFBamJavaFXDbKeyHash128TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash128TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash128TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash128TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
