// Description: Java 25 JavaFX Add Form implementation for Tweak.
...
/**
 *	CFBamJavaFXTweakAddForm JavaFX Add Form implementation
 *	for Tweak.
 */
public class CFBamJavaFXTweakAddForm
extends CFBorderPane
implements ICFBamJavaFXTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Tweak";
	...
	public CFBamJavaFXTweakAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTweakObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTweakFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTweakPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTweakFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTweakPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTweakPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
