// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash384Type.
...
/**
 *	CFBamJavaFXDbKeyHash384TypeAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash384Type.
 */
public class CFBamJavaFXDbKeyHash384TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash384TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash384TypeObj cur = getJavaFXFocusAsDbKeyHash384Type();
				if( cur != null ) {
					ICFBamDbKeyHash384TypeEditObj editObj = (ICFBamDbKeyHash384TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash384TypeObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDbKeyHash384TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamDbKeyHash384TypeObj getEffJavaFXFocus() {
		ICFBamDbKeyHash384TypeObj eff = (ICFBamDbKeyHash384TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash384TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash384TypeObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash384TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash384TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash384TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash384TypeObj)editObj.create();
