// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash224Gen.
...
/**
 *	CFBamJavaFXDbKeyHash224GenAddPane JavaFX Add Pane implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamJavaFXDbKeyHash224GenAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash224GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash224GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
