// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash224Gen.
...
/**
 *	CFBamJavaFXDbKeyHash224GenEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamJavaFXDbKeyHash224GenEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash224GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224GenEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224GenObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash224GenObj focus = (ICFBamDbKeyHash224GenObj)getJavaFXFocusAsDbKeyHash224Gen();
			if( focus != null ) {
