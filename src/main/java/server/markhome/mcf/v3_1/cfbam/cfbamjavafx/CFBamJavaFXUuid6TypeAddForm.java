// Description: Java 25 JavaFX Add Form implementation for Uuid6Type.
...
/**
 *	CFBamJavaFXUuid6TypeAddForm JavaFX Add Form implementation
 *	for Uuid6Type.
 */
public class CFBamJavaFXUuid6TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXUuid6TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Uuid6Type";
	...
	public CFBamJavaFXUuid6TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuid6TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuid6TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuid6TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuid6TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuid6TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
