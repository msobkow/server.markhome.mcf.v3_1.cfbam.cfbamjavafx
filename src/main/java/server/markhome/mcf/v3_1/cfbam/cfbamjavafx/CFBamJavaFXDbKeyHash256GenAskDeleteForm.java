// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash256Gen.
...
/**
 *	CFBamJavaFXDbKeyHash256GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamJavaFXDbKeyHash256GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash256Gen";
	...
	public CFBamJavaFXDbKeyHash256GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash256Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash256GenObj obj = getJavaFXFocusAsDbKeyHash256Gen();
					ICFBamDbKeyHash256GenEditObj editObj = (ICFBamDbKeyHash256GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash256GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash256Gen( ICFBamDbKeyHash256GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash256GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash256GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
