// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash128Type.
...
/**
 *	CFBamJavaFXDbKeyHash128TypeEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash128Type.
 */
public class CFBamJavaFXDbKeyHash128TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash128TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash128TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash128TypeObj focus = (ICFBamDbKeyHash128TypeObj)getJavaFXFocusAsDbKeyHash128Type();
			if( focus != null ) {
