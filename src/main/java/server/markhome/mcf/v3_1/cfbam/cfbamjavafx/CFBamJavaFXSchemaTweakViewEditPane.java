// Description: Java 25 JavaFX View/Edit Pane implementation for SchemaTweak.
...
/**
 *	CFBamJavaFXSchemaTweakViewEditPane JavaFX View/Edit Pane implementation
 *	for SchemaTweak.
 */
public class CFBamJavaFXSchemaTweakViewEditPane
extends CFSplitPane
implements ICFBamJavaFXSchemaTweakPaneCommon
{
	...
	public CFBamJavaFXSchemaTweakViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaTweakObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaTweakPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
