// Description: Java 25 JavaFX Add Pane implementation for Uuid6Type.
...
/**
 *	CFBamJavaFXUuid6TypeAddPane JavaFX Add Pane implementation
 *	for Uuid6Type.
 */
public class CFBamJavaFXUuid6TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXUuid6TypePaneCommon
{
	...
	public CFBamJavaFXUuid6TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuid6TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
