// Description: Java 25 JavaFX Add Form implementation for DbKeyHash128Def.
...
/**
 *	CFBamJavaFXDbKeyHash128DefAddForm JavaFX Add Form implementation
 *	for DbKeyHash128Def.
 */
public class CFBamJavaFXDbKeyHash128DefAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash128Def";
	...
	public CFBamJavaFXDbKeyHash128DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash128DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash128DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash128DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash128DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash128DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
