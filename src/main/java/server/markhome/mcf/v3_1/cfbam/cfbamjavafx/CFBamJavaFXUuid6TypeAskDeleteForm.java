// Description: Java 25 JavaFX Ask Delete Pane implementation for Uuid6Type.
...
/**
 *	CFBamJavaFXUuid6TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Uuid6Type.
 */
public class CFBamJavaFXUuid6TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuid6TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Uuid6Type";
	...
	public CFBamJavaFXUuid6TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Uuid6Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuid6TypeObj obj = getJavaFXFocusAsUuid6Type();
					ICFBamUuid6TypeEditObj editObj = (ICFBamUuid6TypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getUuid6TypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsUuid6Type( ICFBamUuid6TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuid6TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUuid6TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
