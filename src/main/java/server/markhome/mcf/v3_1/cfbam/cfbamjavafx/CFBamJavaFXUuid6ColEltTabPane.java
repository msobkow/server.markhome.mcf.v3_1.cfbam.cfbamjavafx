// Description: Java 25 JavaFX Element TabPane implementation for Uuid6Col.
...
/**
 *	CFBamJavaFXUuid6ColEltTabPane JavaFX Element TabPane implementation
 *	for Uuid6Col.
 */
public class CFBamJavaFXUuid6ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuid6ColPaneCommon
{
	...
	public CFBamJavaFXUuid6ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuid6ColObj focus = (ICFBamUuid6ColObj)getJavaFXFocusAsUuid6Col();
			if( focus != null ) {
