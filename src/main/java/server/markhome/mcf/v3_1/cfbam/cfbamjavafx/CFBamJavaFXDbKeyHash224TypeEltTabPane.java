// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash224Type.
...
/**
 *	CFBamJavaFXDbKeyHash224TypeEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash224Type.
 */
public class CFBamJavaFXDbKeyHash224TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash224TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash224TypeObj focus = (ICFBamDbKeyHash224TypeObj)getJavaFXFocusAsDbKeyHash224Type();
			if( focus != null ) {
