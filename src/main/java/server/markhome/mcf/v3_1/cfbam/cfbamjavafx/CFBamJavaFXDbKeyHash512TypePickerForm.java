// Description: Java 25 JavaFX Picker Form implementation for DbKeyHash512Type.
...
/**
 *	CFBamJavaFXDbKeyHash512TypePickerForm JavaFX Picker Form implementation
 *	for DbKeyHash512Type.
 */
public class CFBamJavaFXDbKeyHash512TypePickerForm
	...
	ICFForm
{
	...
	public CFBamJavaFXDbKeyHash512TypePickerForm( ICFFormManager formManager,
		...
		ICFBamJavaFXDbKeyHash512TypeChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getDbKeyHash512TypeFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxPickerPane).setJavaFXFocus( (ICFBamDbKeyHash512TypeObj)value );
	}
	...
	public Collection<ICFBamDbKeyHash512TypeObj> getJavaFXDataCollection() {
		ICFBamJavaFXDbKeyHash512TypePaneList jplPicker = (ICFBamJavaFXDbKeyHash512TypePaneList)javafxPickerPane;
		Collection<ICFBamDbKeyHash512TypeObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFBamJavaFXDbKeyHash512TypePaneCommon jpanelCommon = (ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxPickerPane;
