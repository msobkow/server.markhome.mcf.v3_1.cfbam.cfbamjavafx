// Description: Java 25 JavaFX Attribute Pane implementation for StringType.
...
implements ICFBamJavaFXStringTypePaneCommon
{
		...
		extends CFLabel
	{
		public MaxLenCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.StringDef.AttrPane.MaxLen.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxLenEditor() {
			super();
			setMinValue( ICFBamStringDef.MAXLEN_MIN_VALUE );
			setMaxValue( ICFBamStringDef.MAXLEN_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.StringDef.AttrPane.MaxLen.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsPolymorphCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.StringDef.AttrPane.IsPolymorph.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsPolymorphEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfbam.javafx.StringDef.AttrPane.IsPolymorph.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.StringDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 500 );
			setFieldNameInzTag( "cfbam.javafx.StringDef.AttrPane.InitValue.EffLabel" );
		}
	}
