// Description: Java 25 JavaFX Attribute Pane implementation for UInt64Type.
...
implements ICFBamJavaFXUInt64TypePaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt64Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFUInt64Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamUInt64Def.INITVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt64Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt64Def.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFUInt64Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamUInt64Def.MINVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt64Def.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt64Def.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFUInt64Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamUInt64Def.MAXVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt64Def.AttrPane.MaxValue.EffLabel" );
		}
	}
