// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash160Type.
...
/**
 *	CFBamJavaFXDbKeyHash160TypeEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash160Type.
 */
public class CFBamJavaFXDbKeyHash160TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash160TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash160TypeObj focus = (ICFBamDbKeyHash160TypeObj)getJavaFXFocusAsDbKeyHash160Type();
			if( focus != null ) {
