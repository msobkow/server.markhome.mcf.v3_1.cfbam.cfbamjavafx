// Description: Java 25 JavaFX Add Form implementation for DbKeyHash224Col.
...
/**
 *	CFBamJavaFXDbKeyHash224ColAddForm JavaFX Add Form implementation
 *	for DbKeyHash224Col.
 */
public class CFBamJavaFXDbKeyHash224ColAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash224ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash224Col";
	...
	public CFBamJavaFXDbKeyHash224ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash224ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash224ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash224ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash224ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash224ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
