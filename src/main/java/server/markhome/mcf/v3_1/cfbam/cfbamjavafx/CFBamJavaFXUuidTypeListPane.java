// Description: Java 25 JavaFX List of Obj Pane implementation for UuidType.
...
implements ICFBamJavaFXUuidTypePaneList
{
	...
	protected TableColumn<ICFBamUuidTypeObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamUuidTypeObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamUuidTypeObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamUuidTypeObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamUuidTypeObj,CFLibDbKeyHash256>,TableCell<ICFBamUuidTypeObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamUuidTypeObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamUuidTypeObj,CFLibDbKeyHash256> arg)
			{
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamUuidType.CLASS_CODE ) {
