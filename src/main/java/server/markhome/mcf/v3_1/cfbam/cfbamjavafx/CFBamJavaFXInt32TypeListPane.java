// Description: Java 25 JavaFX List of Obj Pane implementation for Int32Type.
...
implements ICFBamJavaFXInt32TypePaneList
{
	...
	protected TableColumn<ICFBamInt32TypeObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamInt32TypeObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamInt32TypeObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamInt32TypeObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamInt32TypeObj,CFLibDbKeyHash256>,TableCell<ICFBamInt32TypeObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamInt32TypeObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamInt32TypeObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamInt32TypeObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamInt32Type.CLASS_CODE ) {
