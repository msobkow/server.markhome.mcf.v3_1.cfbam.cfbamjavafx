// Description: Java 25 JavaFX List of Obj Pane implementation for TokenDef.
...
implements ICFBamJavaFXTokenDefPaneList
{
	...
	protected TableColumn<ICFBamTokenDefObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamTokenDefObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamTokenDefObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamTokenDefObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamTokenDefObj,CFLibDbKeyHash256>,TableCell<ICFBamTokenDefObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamTokenDefObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamTokenDefObj,CFLibDbKeyHash256> arg)
			{
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamTokenDef.CLASS_CODE ) {
