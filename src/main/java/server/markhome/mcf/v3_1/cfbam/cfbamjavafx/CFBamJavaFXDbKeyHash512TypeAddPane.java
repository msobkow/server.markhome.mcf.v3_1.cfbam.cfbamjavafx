// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash512Type.
...
/**
 *	CFBamJavaFXDbKeyHash512TypeAddPane JavaFX Add Pane implementation
 *	for DbKeyHash512Type.
 */
public class CFBamJavaFXDbKeyHash512TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash512TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
