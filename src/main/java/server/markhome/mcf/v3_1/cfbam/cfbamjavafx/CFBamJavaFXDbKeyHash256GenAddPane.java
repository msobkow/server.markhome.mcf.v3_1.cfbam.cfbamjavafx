// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash256Gen.
...
/**
 *	CFBamJavaFXDbKeyHash256GenAddPane JavaFX Add Pane implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamJavaFXDbKeyHash256GenAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash256GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash256GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
