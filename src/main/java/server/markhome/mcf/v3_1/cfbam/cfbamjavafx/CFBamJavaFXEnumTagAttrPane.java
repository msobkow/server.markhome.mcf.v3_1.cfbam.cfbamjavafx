// Description: Java 25 JavaFX Attribute Pane implementation for EnumTag.
...
implements ICFBamJavaFXEnumTagPaneCommon
{
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.EnumTag.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.EnumTag.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.EnumTag.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfbam.javafx.EnumTag.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public EnumCodeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.EnumTag.AttrPane.EnumCode.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public EnumCodeEditor() {
			super();
			setMinValue( ICFBamEnumTag.ENUMCODE_MIN_VALUE );
			setMaxValue( ICFBamEnumTag.ENUMCODE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.EnumTag.AttrPane.EnumCode.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.EnumTag.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.EnumTag.AttrPane.Name.EffLabel" );
		}
	}
