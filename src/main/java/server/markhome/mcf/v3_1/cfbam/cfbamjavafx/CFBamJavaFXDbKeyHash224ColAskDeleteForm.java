// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash224Col.
...
/**
 *	CFBamJavaFXDbKeyHash224ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash224Col.
 */
public class CFBamJavaFXDbKeyHash224ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash224ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash224Col";
	...
	public CFBamJavaFXDbKeyHash224ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash224Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash224ColObj obj = getJavaFXFocusAsDbKeyHash224Col();
					ICFBamDbKeyHash224ColEditObj editObj = (ICFBamDbKeyHash224ColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash224ColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash224Col( ICFBamDbKeyHash224ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash224ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash224ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
