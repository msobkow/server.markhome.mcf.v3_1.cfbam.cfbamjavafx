// Description: Java 25 JavaFX Attribute Pane implementation for TokenType.
...
implements ICFBamJavaFXTokenTypePaneCommon
{
		...
		extends CFLabel
	{
		public MaxLenCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TokenDef.AttrPane.MaxLen.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxLenEditor() {
			super();
			setMinValue( ICFBamTokenDef.MAXLEN_MIN_VALUE );
			setMaxValue( ICFBamTokenDef.MAXLEN_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.TokenDef.AttrPane.MaxLen.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TokenDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFTokenEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.TokenDef.AttrPane.InitValue.EffLabel" );
		}
	}
