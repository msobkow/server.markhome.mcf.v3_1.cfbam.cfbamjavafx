// Description: Java 25 JavaFX Attribute Pane implementation for NumberType.
...
implements ICFBamJavaFXNumberTypePaneCommon
{
		...
		extends CFLabel
	{
		public DigitsCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NumberDef.AttrPane.Digits.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public DigitsEditor() {
			super();
			setMinValue( ICFBamNumberDef.DIGITS_MIN_VALUE );
			setMaxValue( ICFBamNumberDef.DIGITS_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.NumberDef.AttrPane.Digits.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public PrecisCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NumberDef.AttrPane.Precis.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public PrecisEditor() {
			super();
			setMinValue( ICFBamNumberDef.PRECIS_MIN_VALUE );
			setMaxValue( ICFBamNumberDef.PRECIS_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.NumberDef.AttrPane.Precis.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NumberDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFNumberEditor
	{
		public InitValueEditor() {
			super( 31, 5 );
			setFieldNameInzTag( "cfbam.javafx.NumberDef.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NumberDef.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFNumberEditor
	{
		public MinValueEditor() {
			super( 31, 5 );
			setFieldNameInzTag( "cfbam.javafx.NumberDef.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NumberDef.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFNumberEditor
	{
		public MaxValueEditor() {
			super( 31, 5 );
			setFieldNameInzTag( "cfbam.javafx.NumberDef.AttrPane.MaxValue.EffLabel" );
		}
	}
