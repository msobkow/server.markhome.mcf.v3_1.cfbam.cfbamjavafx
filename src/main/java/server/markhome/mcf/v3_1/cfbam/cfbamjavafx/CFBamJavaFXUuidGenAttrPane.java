// Description: Java 25 JavaFX Attribute Pane implementation for UuidGen.
...
implements ICFBamJavaFXUuidGenPaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UuidDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFUuidEditor
	{
		public InitValueEditor() {
			super();
			setFieldNameInzTag( "cfbam.javafx.UuidDef.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UuidGen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamUuidGen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamUuidGen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UuidGen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UuidGen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamUuidGen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamUuidGen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UuidGen.AttrPane.BlockSize.EffLabel" );
		}
	}
