// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash160Gen.
...
/**
 *	CFBamJavaFXDbKeyHash160GenEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash160Gen.
 */
public class CFBamJavaFXDbKeyHash160GenEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash160GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160GenEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160GenObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash160GenObj focus = (ICFBamDbKeyHash160GenObj)getJavaFXFocusAsDbKeyHash160Gen();
			if( focus != null ) {
