// Description: Java 25 JavaFX Add Form implementation for DbKeyHash512Col.
...
/**
 *	CFBamJavaFXDbKeyHash512ColAddForm JavaFX Add Form implementation
 *	for DbKeyHash512Col.
 */
public class CFBamJavaFXDbKeyHash512ColAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash512Col";
	...
	public CFBamJavaFXDbKeyHash512ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash512ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash512ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash512ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash512ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
