// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash512Def.
...
/**
 *	CFBamJavaFXDbKeyHash512DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash512Def.
 */
public class CFBamJavaFXDbKeyHash512DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash512Def";
	...
	public CFBamJavaFXDbKeyHash512DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash512Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash512DefObj obj = getJavaFXFocusAsDbKeyHash512Def();
					ICFBamDbKeyHash512DefEditObj editObj = (ICFBamDbKeyHash512DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash512DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash512Def( ICFBamDbKeyHash512DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
