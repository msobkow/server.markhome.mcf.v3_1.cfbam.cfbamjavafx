// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash512Col.
...
/**
 *	CFBamJavaFXDbKeyHash512ColAddPane JavaFX Add Pane implementation
 *	for DbKeyHash512Col.
 */
public class CFBamJavaFXDbKeyHash512ColAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash512ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
