// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash128Def.
...
/**
 *	CFBamJavaFXDbKeyHash128DefAddPane JavaFX Add Pane implementation
 *	for DbKeyHash128Def.
 */
public class CFBamJavaFXDbKeyHash128DefAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash128DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash128DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash128DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
