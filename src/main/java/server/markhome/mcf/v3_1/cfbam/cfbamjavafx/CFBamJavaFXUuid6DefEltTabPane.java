// Description: Java 25 JavaFX Element TabPane implementation for Uuid6Def.
...
/**
 *	CFBamJavaFXUuid6DefEltTabPane JavaFX Element TabPane implementation
 *	for Uuid6Def.
 */
public class CFBamJavaFXUuid6DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuid6DefPaneCommon
{
	...
	public CFBamJavaFXUuid6DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuid6DefObj focus = (ICFBamUuid6DefObj)getJavaFXFocusAsUuid6Def();
			if( focus != null ) {
