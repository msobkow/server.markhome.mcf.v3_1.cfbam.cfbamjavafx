// Description: Java 25 JavaFX Attribute Pane implementation for TZTimestampType.
...
implements ICFBamJavaFXTZTimestampTypePaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TZTimestampDef.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 4 );
			setFieldNameInzTag( "cfbam.javafx.TZTimestampDef.AttrPane.Dummy.EffLabel" );
		}
	}
