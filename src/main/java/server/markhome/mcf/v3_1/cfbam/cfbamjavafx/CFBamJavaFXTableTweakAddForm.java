// Description: Java 25 JavaFX Add Form implementation for TableTweak.
...
/**
 *	CFBamJavaFXTableTweakAddForm JavaFX Add Form implementation
 *	for TableTweak.
 */
public class CFBamJavaFXTableTweakAddForm
extends CFBorderPane
implements ICFBamJavaFXTableTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TableTweak";
	...
	public CFBamJavaFXTableTweakAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableTweakObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTableTweakFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTableTweakPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTableTweakFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTableTweakPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTableTweakPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
