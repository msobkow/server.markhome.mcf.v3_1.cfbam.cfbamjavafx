// Description: Java 25 JavaFX Attribute Pane implementation for BlobType.
...
implements ICFBamJavaFXBlobTypePaneCommon
{
		...
		extends CFLabel
	{
		public MaxLenCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.BlobDef.AttrPane.MaxLen.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxLenEditor() {
			super();
			setMinValue( ICFBamBlobDef.MAXLEN_MIN_VALUE );
			setMaxValue( ICFBamBlobDef.MAXLEN_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.BlobDef.AttrPane.MaxLen.EffLabel" );
		}
	}
