// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash224Def.
...
/**
 *	CFBamJavaFXDbKeyHash224DefAddPane JavaFX Add Pane implementation
 *	for DbKeyHash224Def.
 */
public class CFBamJavaFXDbKeyHash224DefAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash224DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash224DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
