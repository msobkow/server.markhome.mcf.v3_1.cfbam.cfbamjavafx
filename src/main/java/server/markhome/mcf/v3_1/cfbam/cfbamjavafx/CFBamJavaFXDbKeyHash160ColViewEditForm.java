// Description: Java 25 JavaFX View/Edit Form implementation for DbKeyHash160Col.
...
/**
 *	CFBamJavaFXDbKeyHash160ColViewEditForm JavaFX View/Edit Form implementation
 *	for DbKeyHash160Col.
 */
public class CFBamJavaFXDbKeyHash160ColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash160ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DbKeyHash160Col";
	...
	public CFBamJavaFXDbKeyHash160ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDbKeyHash160ColObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getDbKeyHash160ColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamDbKeyHash160ColEditObj editObj = (ICFBamDbKeyHash160ColEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash160ColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamDbKeyHash160ColObj argFocus = (ICFBamDbKeyHash160ColObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDbKeyHash160ColObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDbKeyHash160Col() != null ) {
							if( null == getJavaFXFocusAsDbKeyHash160Col().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsDbKeyHash160Col();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
