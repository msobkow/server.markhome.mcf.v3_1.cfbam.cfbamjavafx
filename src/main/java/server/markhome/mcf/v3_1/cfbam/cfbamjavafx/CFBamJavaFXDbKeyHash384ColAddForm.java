// Description: Java 25 JavaFX Add Form implementation for DbKeyHash384Col.
...
/**
 *	CFBamJavaFXDbKeyHash384ColAddForm JavaFX Add Form implementation
 *	for DbKeyHash384Col.
 */
public class CFBamJavaFXDbKeyHash384ColAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash384Col";
	...
	public CFBamJavaFXDbKeyHash384ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash384ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash384ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash384ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash384ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash384ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
