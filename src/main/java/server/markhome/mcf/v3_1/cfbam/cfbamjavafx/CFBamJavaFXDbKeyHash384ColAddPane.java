// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash384Col.
...
/**
 *	CFBamJavaFXDbKeyHash384ColAddPane JavaFX Add Pane implementation
 *	for DbKeyHash384Col.
 */
public class CFBamJavaFXDbKeyHash384ColAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash384ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash384ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash384ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
