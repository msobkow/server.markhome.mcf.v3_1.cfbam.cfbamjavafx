// Description: Java 25 JavaFX Picker of Obj Pane implementation for SchemaRole.
...
/**
 *	CFBamJavaFXSchemaRolePickerPane JavaFX Pick Obj Pane implementation
 *	for SchemaRole.
 */
public class CFBamJavaFXSchemaRolePickerPane
extends CFBorderPane
implements ICFBamJavaFXSchemaRolePaneList
{
	public static String S_FormName = "Choose SchemaRole";
	...
	protected ICFBamJavaFXSchemaRoleChosen invokeWhenChosen = null;
	protected ICFBamSchemaDefObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXSchemaRolePickerPane( ICFFormManager formManager,
		...
		ICFBamJavaFXSchemaRoleChosen whenChosen )
	{
		...
		tableColumnMembershipString = new TableColumn<ICFBamSchemaRoleObj,String>( "Membership" );
		tableColumnMembershipString.setCellValueFactory( new Callback<CellDataFeatures<ICFBamSchemaRoleObj,String>,ObservableValue<String> >() {
			public ObservableValue<String> call( CellDataFeatures<ICFBamSchemaRoleObj, String> p ) {
				ICFBamRoleDefObj obj = p.getValue();
				if( obj == null ) {
					return( null );
		...
		tableColumnMembershipString.setCellFactory( new Callback<TableColumn<ICFBamSchemaRoleObj,String>,TableCell<ICFBamSchemaRoleObj,String>>() {
			@Override public TableCell<ICFBamSchemaRoleObj,String> call(
				TableColumn<ICFBamSchemaRoleObj,String> arg)
			{
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSchemaRole( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSchemaRole( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
