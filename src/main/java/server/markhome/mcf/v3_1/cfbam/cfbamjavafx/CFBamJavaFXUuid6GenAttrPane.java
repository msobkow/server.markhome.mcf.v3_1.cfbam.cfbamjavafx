// Description: Java 25 JavaFX Attribute Pane implementation for Uuid6Gen.
...
/**
 *	CFBamJavaFXUuid6GenAttrPane JavaFX Attribute Pane implementation
 *	for Uuid6Gen.
 */
public class CFBamJavaFXUuid6GenAttrPane
extends CFGridPane
implements ICFBamJavaFXUuid6GenPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUuid6GenObj cur = getJavaFXFocusAsUuid6Gen();
				if( cur != null ) {
					ICFBamUuid6GenEditObj editObj = (ICFBamUuid6GenEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUuid6GenObj focus = getEffJavaFXFocus();
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Uuid6Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 62 );
			setFieldNameInzTag( "cfbam.javafx.Uuid6Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Uuid6Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamUuid6Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamUuid6Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Uuid6Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Uuid6Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamUuid6Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamUuid6Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Uuid6Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
	...
	public CFBamJavaFXUuid6GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsUuid6Gen( argFocus );
	...
	public ICFBamUuid6GenObj getEffJavaFXFocus() {
		ICFBamUuid6GenObj eff = (ICFBamUuid6GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUuid6GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUuid6GenObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamUuid6GenObj focus = getJavaFXFocusAsUuid6Gen();
		ICFBamUuid6GenEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUuid6GenEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUuid6GenEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUuid6GenObj)editObj.create();
