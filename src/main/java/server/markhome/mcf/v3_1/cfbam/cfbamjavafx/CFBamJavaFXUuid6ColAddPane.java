// Description: Java 25 JavaFX Add Pane implementation for Uuid6Col.
...
/**
 *	CFBamJavaFXUuid6ColAddPane JavaFX Add Pane implementation
 *	for Uuid6Col.
 */
public class CFBamJavaFXUuid6ColAddPane
extends CFSplitPane
implements ICFBamJavaFXUuid6ColPaneCommon
{
	...
	public CFBamJavaFXUuid6ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuid6ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
