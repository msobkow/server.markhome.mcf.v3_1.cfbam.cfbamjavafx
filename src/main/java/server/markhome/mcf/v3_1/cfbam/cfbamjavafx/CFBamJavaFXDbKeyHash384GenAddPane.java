// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash384Gen.
...
/**
 *	CFBamJavaFXDbKeyHash384GenAddPane JavaFX Add Pane implementation
 *	for DbKeyHash384Gen.
 */
public class CFBamJavaFXDbKeyHash384GenAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash384GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash384GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash384GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
