// Description: Java 25 JavaFX Add Form implementation for DbKeyHash224Def.
...
/**
 *	CFBamJavaFXDbKeyHash224DefAddForm JavaFX Add Form implementation
 *	for DbKeyHash224Def.
 */
public class CFBamJavaFXDbKeyHash224DefAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash224DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash224Def";
	...
	public CFBamJavaFXDbKeyHash224DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash224DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash224DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash224DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash224DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash224DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
