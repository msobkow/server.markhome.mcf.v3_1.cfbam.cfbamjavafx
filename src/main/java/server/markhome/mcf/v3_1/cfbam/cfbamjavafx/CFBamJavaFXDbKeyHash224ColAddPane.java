// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash224Col.
...
/**
 *	CFBamJavaFXDbKeyHash224ColAddPane JavaFX Add Pane implementation
 *	for DbKeyHash224Col.
 */
public class CFBamJavaFXDbKeyHash224ColAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash224ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash224ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
