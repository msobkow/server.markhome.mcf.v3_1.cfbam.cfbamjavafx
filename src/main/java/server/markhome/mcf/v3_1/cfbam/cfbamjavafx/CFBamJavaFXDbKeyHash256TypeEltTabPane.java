// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash256Type.
...
/**
 *	CFBamJavaFXDbKeyHash256TypeEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash256Type.
 */
public class CFBamJavaFXDbKeyHash256TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash256TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash256TypeObj focus = (ICFBamDbKeyHash256TypeObj)getJavaFXFocusAsDbKeyHash256Type();
			if( focus != null ) {
