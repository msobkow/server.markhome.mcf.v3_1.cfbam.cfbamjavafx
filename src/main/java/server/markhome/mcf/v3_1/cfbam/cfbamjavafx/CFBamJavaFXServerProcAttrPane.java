// Description: Java 25 JavaFX Attribute Pane implementation for ServerProc.
...
implements ICFBamJavaFXServerProcPaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.ServerProc.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 16 );
			setFieldNameInzTag( "cfbam.javafx.ServerProc.AttrPane.Dummy.EffLabel" );
		}
	}
