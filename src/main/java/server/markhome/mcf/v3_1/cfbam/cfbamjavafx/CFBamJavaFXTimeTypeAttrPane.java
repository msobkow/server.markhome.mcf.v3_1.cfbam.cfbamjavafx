// Description: Java 25 JavaFX Attribute Pane implementation for TimeType.
...
implements ICFBamJavaFXTimeTypePaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TimeDef.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 4 );
			setFieldNameInzTag( "cfbam.javafx.TimeDef.AttrPane.Dummy.EffLabel" );
		}
	}
