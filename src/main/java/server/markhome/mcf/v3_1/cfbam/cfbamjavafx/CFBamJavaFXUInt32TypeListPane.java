// Description: Java 25 JavaFX List of Obj Pane implementation for UInt32Type.
...
implements ICFBamJavaFXUInt32TypePaneList
{
	...
	protected TableColumn<ICFBamUInt32TypeObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamUInt32TypeObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamUInt32TypeObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamUInt32TypeObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamUInt32TypeObj,CFLibDbKeyHash256>,TableCell<ICFBamUInt32TypeObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamUInt32TypeObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamUInt32TypeObj,CFLibDbKeyHash256> arg)
			{
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamUInt32Type.CLASS_CODE ) {
