// Description: Java 25 JavaFX Picker of Obj Pane implementation for DbKeyHash384Col.
...
/**
 *	CFBamJavaFXDbKeyHash384ColPickerPane JavaFX Pick Obj Pane implementation
 *	for DbKeyHash384Col.
 */
public class CFBamJavaFXDbKeyHash384ColPickerPane
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384ColPaneList
{
	public static String S_FormName = "Choose DbKeyHash384Col";
	...
	protected ICFBamJavaFXDbKeyHash384ColChosen invokeWhenChosen = null;
	protected ICFBamTableObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXDbKeyHash384ColPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseDbKeyHash384Col( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseDbKeyHash384Col( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
