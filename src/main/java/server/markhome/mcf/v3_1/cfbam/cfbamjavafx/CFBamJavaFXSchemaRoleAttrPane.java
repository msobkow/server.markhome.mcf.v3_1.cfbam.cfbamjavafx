// Description: Java 25 JavaFX Attribute Pane implementation for SchemaRole.
...
/**
 *	CFBamJavaFXSchemaRoleAttrPane JavaFX Attribute Pane implementation
 *	for SchemaRole.
 */
public class CFBamJavaFXSchemaRoleAttrPane
extends CFGridPane
implements ICFBamJavaFXSchemaRolePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamSchemaRoleObj cur = getJavaFXFocusAsSchemaRole();
				if( cur != null ) {
					ICFBamSchemaRoleEditObj editObj = (ICFBamSchemaRoleEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamSchemaRoleObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXSchemaRoleAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRoleObj argFocus ) {
		...
		setJavaFXFocusAsSchemaRole( argFocus );
	...
	public ICFBamSchemaRoleObj getEffJavaFXFocus() {
		ICFBamSchemaRoleObj eff = (ICFBamSchemaRoleObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamSchemaRoleObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	public void postFields()
	{
		...
		ICFBamSchemaRoleObj focus = getJavaFXFocusAsSchemaRole();
		ICFBamSchemaRoleEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamSchemaRoleEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamSchemaRoleEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamSchemaRoleObj)editObj.create();
