// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash512Gen.
...
/**
 *	CFBamJavaFXDbKeyHash512GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash512Gen.
 */
public class CFBamJavaFXDbKeyHash512GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash512Gen";
	...
	public CFBamJavaFXDbKeyHash512GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash512Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash512GenObj obj = getJavaFXFocusAsDbKeyHash512Gen();
					ICFBamDbKeyHash512GenEditObj editObj = (ICFBamDbKeyHash512GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash512GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash512Gen( ICFBamDbKeyHash512GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
