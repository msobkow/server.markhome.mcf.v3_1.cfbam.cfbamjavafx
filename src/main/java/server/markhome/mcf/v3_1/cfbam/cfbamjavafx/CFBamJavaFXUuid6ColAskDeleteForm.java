// Description: Java 25 JavaFX Ask Delete Pane implementation for Uuid6Col.
...
/**
 *	CFBamJavaFXUuid6ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Uuid6Col.
 */
public class CFBamJavaFXUuid6ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuid6ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Uuid6Col";
	...
	public CFBamJavaFXUuid6ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Uuid6Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuid6ColObj obj = getJavaFXFocusAsUuid6Col();
					ICFBamUuid6ColEditObj editObj = (ICFBamUuid6ColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getUuid6ColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsUuid6Col( ICFBamUuid6ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuid6ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUuid6ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
