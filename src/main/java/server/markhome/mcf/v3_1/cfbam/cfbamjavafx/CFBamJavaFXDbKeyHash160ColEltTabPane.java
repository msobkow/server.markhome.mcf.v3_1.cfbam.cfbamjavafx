// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash160Col.
...
/**
 *	CFBamJavaFXDbKeyHash160ColEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash160Col.
 */
public class CFBamJavaFXDbKeyHash160ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash160ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash160ColObj focus = (ICFBamDbKeyHash160ColObj)getJavaFXFocusAsDbKeyHash160Col();
			if( focus != null ) {
