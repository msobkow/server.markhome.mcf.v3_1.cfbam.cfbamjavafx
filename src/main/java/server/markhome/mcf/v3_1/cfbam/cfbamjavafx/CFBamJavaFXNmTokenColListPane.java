// Description: Java 25 JavaFX List of Obj Pane implementation for NmTokenCol.
...
implements ICFBamJavaFXNmTokenColPaneList
{
	...
	protected TableColumn<ICFBamNmTokenColObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamNmTokenColObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamNmTokenColObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamNmTokenColObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamNmTokenColObj,CFLibDbKeyHash256>,TableCell<ICFBamNmTokenColObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamNmTokenColObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamNmTokenColObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamNmTokenColObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamNmTokenCol.CLASS_CODE ) {
