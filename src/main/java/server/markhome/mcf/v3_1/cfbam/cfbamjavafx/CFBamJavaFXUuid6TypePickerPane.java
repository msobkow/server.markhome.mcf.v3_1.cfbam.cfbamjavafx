// Description: Java 25 JavaFX Picker of Obj Pane implementation for Uuid6Type.
...
/**
 *	CFBamJavaFXUuid6TypePickerPane JavaFX Pick Obj Pane implementation
 *	for Uuid6Type.
 */
public class CFBamJavaFXUuid6TypePickerPane
extends CFBorderPane
implements ICFBamJavaFXUuid6TypePaneList
{
	public static String S_FormName = "Choose Uuid6Type";
	...
	protected ICFBamJavaFXUuid6TypeChosen invokeWhenChosen = null;
	protected ICFBamSchemaDefObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXUuid6TypePickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseUuid6Type( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseUuid6Type( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
