// Description: Java 25 JavaFX Attribute Pane implementation for NmTokensType.
...
implements ICFBamJavaFXNmTokensTypePaneCommon
{
		...
		extends CFLabel
	{
		public MaxLenCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NmTokensDef.AttrPane.MaxLen.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxLenEditor() {
			super();
			setMinValue( ICFBamNmTokensDef.MAXLEN_MIN_VALUE );
			setMaxValue( ICFBamNmTokensDef.MAXLEN_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.NmTokensDef.AttrPane.MaxLen.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.NmTokensDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFNmTokensEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 256 );
			setFieldNameInzTag( "cfbam.javafx.NmTokensDef.AttrPane.InitValue.EffLabel" );
		}
	}
