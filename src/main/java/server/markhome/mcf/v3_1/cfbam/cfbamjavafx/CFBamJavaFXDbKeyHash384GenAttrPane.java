// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash384Gen.
...
/**
 *	CFBamJavaFXDbKeyHash384GenAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash384Gen.
 */
public class CFBamJavaFXDbKeyHash384GenAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash384GenPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash384GenObj cur = getJavaFXFocusAsDbKeyHash384Gen();
				if( cur != null ) {
					ICFBamDbKeyHash384GenEditObj editObj = (ICFBamDbKeyHash384GenEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash384GenObj focus = getEffJavaFXFocus();
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash384Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 96 );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash384Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash384Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamDbKeyHash384Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash384Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash384Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash384Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamDbKeyHash384Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash384Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash384Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
	...
	public CFBamJavaFXDbKeyHash384GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsDbKeyHash384Gen( argFocus );
	...
	public ICFBamDbKeyHash384GenObj getEffJavaFXFocus() {
		ICFBamDbKeyHash384GenObj eff = (ICFBamDbKeyHash384GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash384GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash384GenObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash384GenObj focus = getJavaFXFocusAsDbKeyHash384Gen();
		ICFBamDbKeyHash384GenEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash384GenEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash384GenEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash384GenObj)editObj.create();
