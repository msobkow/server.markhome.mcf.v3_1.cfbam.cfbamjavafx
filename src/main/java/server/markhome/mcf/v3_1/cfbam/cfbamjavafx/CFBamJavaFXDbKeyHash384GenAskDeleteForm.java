// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash384Gen.
...
/**
 *	CFBamJavaFXDbKeyHash384GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash384Gen.
 */
public class CFBamJavaFXDbKeyHash384GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash384Gen";
	...
	public CFBamJavaFXDbKeyHash384GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash384Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash384GenObj obj = getJavaFXFocusAsDbKeyHash384Gen();
					ICFBamDbKeyHash384GenEditObj editObj = (ICFBamDbKeyHash384GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash384GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash384Gen( ICFBamDbKeyHash384GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash384GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash384GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
