// Description: Java 25 JavaFX Add Form implementation for DbKeyHash128Gen.
...
/**
 *	CFBamJavaFXDbKeyHash128GenAddForm JavaFX Add Form implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamJavaFXDbKeyHash128GenAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash128Gen";
	...
	public CFBamJavaFXDbKeyHash128GenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128GenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash128GenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash128GenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash128GenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash128GenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash128GenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
