// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash128Gen.
...
/**
 *	CFBamJavaFXDbKeyHash128GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamJavaFXDbKeyHash128GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash128Gen";
	...
	public CFBamJavaFXDbKeyHash128GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash128Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash128GenObj obj = getJavaFXFocusAsDbKeyHash128Gen();
					ICFBamDbKeyHash128GenEditObj editObj = (ICFBamDbKeyHash128GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash128GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash128Gen( ICFBamDbKeyHash128GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash128GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash128GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
