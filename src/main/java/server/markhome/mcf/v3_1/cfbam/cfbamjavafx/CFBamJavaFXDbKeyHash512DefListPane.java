// Description: Java 25 JavaFX List of Obj Pane implementation for DbKeyHash512Def.
...
/**
 *	CFBamJavaFXDbKeyHash512DefListPane JavaFX List of Obj Pane implementation
 *	for DbKeyHash512Def.
 */
public class CFBamJavaFXDbKeyHash512DefListPane
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512DefPaneList
{
	public static String S_FormName = "List DbKeyHash512Def";
	...
	public CFBamJavaFXDbKeyHash512DefListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		...
		if( observableListOfDbKeyHash512Def != null ) {
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash512Def.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getDbKeyHash512DefFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
								...
								throw new CFLibUnsupportedClassException( getClass(),
									...
									"selectedInstance",
									selectedInstance,
									"ICFBamDbKeyHash512DefObj, ICFBamDbKeyHash512ColObj, ICFBamDbKeyHash512TypeObj, ICFBamDbKeyHash512GenObj" );
							}
						}
					}
					catch( Throwable t ) {
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							int backingClassCode = entry.getBackingClassCode();
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash512Def.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getDbKeyHash512DefFactory().newAskDeleteForm( cfFormManager, selectedInstance, getDeleteCallback() );
								((ICFBamJavaFXDbKeyHash512DefPaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash512Col.CLASS_CODE ) {
