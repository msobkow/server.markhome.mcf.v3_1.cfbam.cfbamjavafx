// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash256Def.
...
/**
 *	CFBamJavaFXDbKeyHash256DefEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash256Def.
 */
public class CFBamJavaFXDbKeyHash256DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash256DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash256DefObj focus = (ICFBamDbKeyHash256DefObj)getJavaFXFocusAsDbKeyHash256Def();
			if( focus != null ) {
