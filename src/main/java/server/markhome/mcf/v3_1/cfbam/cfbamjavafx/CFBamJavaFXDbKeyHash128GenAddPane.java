// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash128Gen.
...
/**
 *	CFBamJavaFXDbKeyHash128GenAddPane JavaFX Add Pane implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamJavaFXDbKeyHash128GenAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash128GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash128GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash128GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
