// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash128Gen.
...
/**
 *	CFBamJavaFXDbKeyHash128GenAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamJavaFXDbKeyHash128GenAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash128GenPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash128GenObj cur = getJavaFXFocusAsDbKeyHash128Gen();
				if( cur != null ) {
					ICFBamDbKeyHash128GenEditObj editObj = (ICFBamDbKeyHash128GenEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash128GenObj focus = getEffJavaFXFocus();
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash128Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 32 );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash128Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash128Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamDbKeyHash128Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash128Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash128Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash128Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamDbKeyHash128Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash128Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash128Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
	...
	public CFBamJavaFXDbKeyHash128GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsDbKeyHash128Gen( argFocus );
	...
	public ICFBamDbKeyHash128GenObj getEffJavaFXFocus() {
		ICFBamDbKeyHash128GenObj eff = (ICFBamDbKeyHash128GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash128GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash128GenObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash128GenObj focus = getJavaFXFocusAsDbKeyHash128Gen();
		ICFBamDbKeyHash128GenEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash128GenEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash128GenEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash128GenObj)editObj.create();
