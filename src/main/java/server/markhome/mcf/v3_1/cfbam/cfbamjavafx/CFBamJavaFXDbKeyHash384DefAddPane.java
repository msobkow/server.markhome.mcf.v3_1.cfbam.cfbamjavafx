// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash384Def.
...
/**
 *	CFBamJavaFXDbKeyHash384DefAddPane JavaFX Add Pane implementation
 *	for DbKeyHash384Def.
 */
public class CFBamJavaFXDbKeyHash384DefAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash384DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash384DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash384DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
