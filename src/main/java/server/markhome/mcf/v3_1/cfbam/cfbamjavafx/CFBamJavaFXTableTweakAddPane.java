// Description: Java 25 JavaFX Add Pane implementation for TableTweak.
...
/**
 *	CFBamJavaFXTableTweakAddPane JavaFX Add Pane implementation
 *	for TableTweak.
 */
public class CFBamJavaFXTableTweakAddPane
extends CFSplitPane
implements ICFBamJavaFXTableTweakPaneCommon
{
	...
	public CFBamJavaFXTableTweakAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableTweakObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTableTweakPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
