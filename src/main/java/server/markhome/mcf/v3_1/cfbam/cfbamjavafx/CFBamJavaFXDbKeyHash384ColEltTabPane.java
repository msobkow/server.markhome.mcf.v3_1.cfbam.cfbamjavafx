// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash384Col.
...
/**
 *	CFBamJavaFXDbKeyHash384ColEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash384Col.
 */
public class CFBamJavaFXDbKeyHash384ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash384ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash384ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash384ColObj focus = (ICFBamDbKeyHash384ColObj)getJavaFXFocusAsDbKeyHash384Col();
			if( focus != null ) {
