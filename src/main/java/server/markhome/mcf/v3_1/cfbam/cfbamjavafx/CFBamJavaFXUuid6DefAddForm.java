// Description: Java 25 JavaFX Add Form implementation for Uuid6Def.
...
/**
 *	CFBamJavaFXUuid6DefAddForm JavaFX Add Form implementation
 *	for Uuid6Def.
 */
public class CFBamJavaFXUuid6DefAddForm
extends CFBorderPane
implements ICFBamJavaFXUuid6DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Uuid6Def";
	...
	public CFBamJavaFXUuid6DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuid6DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuid6DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuid6DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuid6DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuid6DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
