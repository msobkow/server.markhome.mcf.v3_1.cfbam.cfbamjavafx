// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash128Def.
...
/**
 *	CFBamJavaFXDbKeyHash128DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash128Def.
 */
public class CFBamJavaFXDbKeyHash128DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash128Def";
	...
	public CFBamJavaFXDbKeyHash128DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash128Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash128DefObj obj = getJavaFXFocusAsDbKeyHash128Def();
					ICFBamDbKeyHash128DefEditObj editObj = (ICFBamDbKeyHash128DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash128DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash128Def( ICFBamDbKeyHash128DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash128DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash128DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
