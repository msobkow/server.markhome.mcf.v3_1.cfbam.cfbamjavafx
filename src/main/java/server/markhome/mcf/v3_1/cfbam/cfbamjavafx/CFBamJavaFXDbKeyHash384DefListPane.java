// Description: Java 25 JavaFX List of Obj Pane implementation for DbKeyHash384Def.
...
/**
 *	CFBamJavaFXDbKeyHash384DefListPane JavaFX List of Obj Pane implementation
 *	for DbKeyHash384Def.
 */
public class CFBamJavaFXDbKeyHash384DefListPane
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384DefPaneList
{
	public static String S_FormName = "List DbKeyHash384Def";
	...
	public CFBamJavaFXDbKeyHash384DefListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		...
		if( observableListOfDbKeyHash384Def != null ) {
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash384Def.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getDbKeyHash384DefFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
								...
								throw new CFLibUnsupportedClassException( getClass(),
									...
									"selectedInstance",
									selectedInstance,
									"ICFBamDbKeyHash384DefObj, ICFBamDbKeyHash384ColObj, ICFBamDbKeyHash384TypeObj, ICFBamDbKeyHash384GenObj" );
							}
						}
					}
					catch( Throwable t ) {
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							int backingClassCode = entry.getBackingClassCode();
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash384Def.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getDbKeyHash384DefFactory().newAskDeleteForm( cfFormManager, selectedInstance, getDeleteCallback() );
								((ICFBamJavaFXDbKeyHash384DefPaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash384Col.CLASS_CODE ) {
