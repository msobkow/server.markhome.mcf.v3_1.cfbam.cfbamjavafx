// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash256Type.
...
/**
 *	CFBamJavaFXDbKeyHash256TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash256Type.
 */
public class CFBamJavaFXDbKeyHash256TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash256Type";
	...
	public CFBamJavaFXDbKeyHash256TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash256Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash256TypeObj obj = getJavaFXFocusAsDbKeyHash256Type();
					ICFBamDbKeyHash256TypeEditObj editObj = (ICFBamDbKeyHash256TypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash256TypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash256Type( ICFBamDbKeyHash256TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash256TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash256TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
