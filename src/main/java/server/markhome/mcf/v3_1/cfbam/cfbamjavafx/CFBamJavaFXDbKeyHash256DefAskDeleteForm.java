// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash256Def.
...
/**
 *	CFBamJavaFXDbKeyHash256DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash256Def.
 */
public class CFBamJavaFXDbKeyHash256DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash256Def";
	...
	public CFBamJavaFXDbKeyHash256DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash256Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash256DefObj obj = getJavaFXFocusAsDbKeyHash256Def();
					ICFBamDbKeyHash256DefEditObj editObj = (ICFBamDbKeyHash256DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash256DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash256Def( ICFBamDbKeyHash256DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash256DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash256DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
