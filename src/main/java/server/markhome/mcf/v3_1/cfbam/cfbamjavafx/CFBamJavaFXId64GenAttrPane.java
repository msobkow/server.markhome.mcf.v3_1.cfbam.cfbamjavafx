// Description: Java 25 JavaFX Attribute Pane implementation for Id64Gen.
...
implements ICFBamJavaFXId64GenPaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int64Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFInt64Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamInt64Def.INITVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt64Def.INITVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int64Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int64Def.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFInt64Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamInt64Def.MINVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt64Def.MINVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int64Def.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Int64Def.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFInt64Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamInt64Def.MAXVALUE_MIN_VALUE );
			setMaxValue( ICFBamInt64Def.MAXVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Int64Def.AttrPane.MaxValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Id64Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamId64Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamId64Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Id64Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Id64Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt64Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamId64Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamId64Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.Id64Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
