// Description: Java 25 JavaFX Element TabPane implementation for Uuid6Gen.
...
/**
 *	CFBamJavaFXUuid6GenEltTabPane JavaFX Element TabPane implementation
 *	for Uuid6Gen.
 */
public class CFBamJavaFXUuid6GenEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuid6GenPaneCommon
{
	...
	public CFBamJavaFXUuid6GenEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6GenObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuid6GenObj focus = (ICFBamUuid6GenObj)getJavaFXFocusAsUuid6Gen();
			if( focus != null ) {
