// Description: Java 25 JavaFX List of Obj Pane implementation for TimeCol.
...
implements ICFBamJavaFXTimeColPaneList
{
	...
	protected TableColumn<ICFBamTimeColObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamTimeColObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamTimeColObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamTimeColObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamTimeColObj,CFLibDbKeyHash256>,TableCell<ICFBamTimeColObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamTimeColObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamTimeColObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamTimeColObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamTimeCol.CLASS_CODE ) {
