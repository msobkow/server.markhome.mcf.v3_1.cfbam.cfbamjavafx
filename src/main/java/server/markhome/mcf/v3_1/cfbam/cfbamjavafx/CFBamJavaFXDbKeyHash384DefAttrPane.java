// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash384Def.
...
/**
 *	CFBamJavaFXDbKeyHash384DefAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash384Def.
 */
public class CFBamJavaFXDbKeyHash384DefAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash384DefPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash384DefObj cur = getJavaFXFocusAsDbKeyHash384Def();
				if( cur != null ) {
					ICFBamDbKeyHash384DefEditObj editObj = (ICFBamDbKeyHash384DefEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash384DefObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDbKeyHash384DefAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384DefObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsDbKeyHash384Def( argFocus );
	...
	public ICFBamDbKeyHash384DefObj getEffJavaFXFocus() {
		ICFBamDbKeyHash384DefObj eff = (ICFBamDbKeyHash384DefObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash384DefObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash384DefObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash384DefEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash384DefEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash384DefEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash384DefObj)editObj.create();
