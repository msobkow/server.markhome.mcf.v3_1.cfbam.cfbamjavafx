// Description: Java 25 JavaFX Add Form implementation for Uuid6Col.
...
/**
 *	CFBamJavaFXUuid6ColAddForm JavaFX Add Form implementation
 *	for Uuid6Col.
 */
public class CFBamJavaFXUuid6ColAddForm
extends CFBorderPane
implements ICFBamJavaFXUuid6ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Uuid6Col";
	...
	public CFBamJavaFXUuid6ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuid6ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuid6ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuid6ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuid6ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuid6ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
