// Description: Java 25 JavaFX View/Edit Form implementation for Tweak.
...
/**
 *	CFBamJavaFXTweakViewEditForm JavaFX View/Edit Form implementation
 *	for Tweak.
 */
public class CFBamJavaFXTweakViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Tweak";
	...
	public CFBamJavaFXTweakViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTweakObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTweakObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getTweakFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamTweakEditObj editObj = (ICFBamTweakEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTweakPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamTweakObj argFocus = (ICFBamTweakObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTweakObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTweak() != null ) {
							if( null == getJavaFXFocusAsTweak().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTweakPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTweakPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
