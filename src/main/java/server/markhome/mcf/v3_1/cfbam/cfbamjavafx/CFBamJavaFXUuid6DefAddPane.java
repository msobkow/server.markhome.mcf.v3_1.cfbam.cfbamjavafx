// Description: Java 25 JavaFX Add Pane implementation for Uuid6Def.
...
/**
 *	CFBamJavaFXUuid6DefAddPane JavaFX Add Pane implementation
 *	for Uuid6Def.
 */
public class CFBamJavaFXUuid6DefAddPane
extends CFSplitPane
implements ICFBamJavaFXUuid6DefPaneCommon
{
	...
	public CFBamJavaFXUuid6DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuid6DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuid6DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
