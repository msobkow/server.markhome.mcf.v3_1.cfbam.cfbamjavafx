// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash224Def.
...
/**
 *	CFBamJavaFXDbKeyHash224DefEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash224Def.
 */
public class CFBamJavaFXDbKeyHash224DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash224DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash224DefObj focus = (ICFBamDbKeyHash224DefObj)getJavaFXFocusAsDbKeyHash224Def();
			if( focus != null ) {
