// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash256Gen.
...
/**
 *	CFBamJavaFXDbKeyHash256GenEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamJavaFXDbKeyHash256GenEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash256GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256GenEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256GenObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash256GenObj focus = (ICFBamDbKeyHash256GenObj)getJavaFXFocusAsDbKeyHash256Gen();
			if( focus != null ) {
