// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash512Def.
...
/**
 *	CFBamJavaFXDbKeyHash512DefAddPane JavaFX Add Pane implementation
 *	for DbKeyHash512Def.
 */
public class CFBamJavaFXDbKeyHash512DefAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash512DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
