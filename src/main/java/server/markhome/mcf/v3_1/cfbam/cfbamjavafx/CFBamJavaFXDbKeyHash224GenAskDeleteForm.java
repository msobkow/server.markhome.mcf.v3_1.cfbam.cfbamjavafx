// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash224Gen.
...
/**
 *	CFBamJavaFXDbKeyHash224GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamJavaFXDbKeyHash224GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash224GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash224Gen";
	...
	public CFBamJavaFXDbKeyHash224GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash224Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash224GenObj obj = getJavaFXFocusAsDbKeyHash224Gen();
					ICFBamDbKeyHash224GenEditObj editObj = (ICFBamDbKeyHash224GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash224GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash224Gen( ICFBamDbKeyHash224GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash224GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash224GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
