// Description: Java 25 JavaFX Attribute Pane implementation for FloatType.
...
implements ICFBamJavaFXFloatTypePaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.FloatDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFFloatEditor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamFloatDef.INITVALUE_MIN_VALUE );
			setMaxValue( ICFBamFloatDef.INITVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.FloatDef.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.FloatDef.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFFloatEditor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamFloatDef.MINVALUE_MIN_VALUE );
			setMaxValue( ICFBamFloatDef.MINVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.FloatDef.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.FloatDef.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFFloatEditor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamFloatDef.MAXVALUE_MIN_VALUE );
			setMaxValue( ICFBamFloatDef.MAXVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.FloatDef.AttrPane.MaxValue.EffLabel" );
		}
	}
