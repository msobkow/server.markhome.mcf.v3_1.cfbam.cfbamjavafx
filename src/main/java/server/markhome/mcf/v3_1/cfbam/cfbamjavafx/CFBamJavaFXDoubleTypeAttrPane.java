// Description: Java 25 JavaFX Attribute Pane implementation for DoubleType.
...
implements ICFBamJavaFXDoubleTypePaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DoubleDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFDoubleEditor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamDoubleDef.INITVALUE_MIN_VALUE );
			setMaxValue( ICFBamDoubleDef.INITVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DoubleDef.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DoubleDef.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFDoubleEditor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamDoubleDef.MINVALUE_MIN_VALUE );
			setMaxValue( ICFBamDoubleDef.MINVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DoubleDef.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DoubleDef.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFDoubleEditor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamDoubleDef.MAXVALUE_MIN_VALUE );
			setMaxValue( ICFBamDoubleDef.MAXVALUE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DoubleDef.AttrPane.MaxValue.EffLabel" );
		}
	}
