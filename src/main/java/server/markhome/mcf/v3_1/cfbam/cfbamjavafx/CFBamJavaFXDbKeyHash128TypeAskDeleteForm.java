// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash128Type.
...
/**
 *	CFBamJavaFXDbKeyHash128TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash128Type.
 */
public class CFBamJavaFXDbKeyHash128TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash128TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash128Type";
	...
	public CFBamJavaFXDbKeyHash128TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash128Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash128TypeObj obj = getJavaFXFocusAsDbKeyHash128Type();
					ICFBamDbKeyHash128TypeEditObj editObj = (ICFBamDbKeyHash128TypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash128TypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash128Type( ICFBamDbKeyHash128TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash128TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash128TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
