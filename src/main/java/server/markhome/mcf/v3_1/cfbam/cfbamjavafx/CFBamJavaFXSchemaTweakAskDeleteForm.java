// Description: Java 25 JavaFX Ask Delete Pane implementation for SchemaTweak.
...
/**
 *	CFBamJavaFXSchemaTweakAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SchemaTweak.
 */
public class CFBamJavaFXSchemaTweakAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXSchemaTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete SchemaTweak";
	...
	public CFBamJavaFXSchemaTweakAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaTweakObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this SchemaTweak?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamSchemaTweakObj obj = getJavaFXFocusAsSchemaTweak();
					ICFBamSchemaTweakEditObj editObj = (ICFBamSchemaTweakEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSchemaTweakFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSchemaTweak( ICFBamSchemaTweakObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaTweakPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaTweakPaneCommon)attrPane).setPaneMode( value );
		}
	}
