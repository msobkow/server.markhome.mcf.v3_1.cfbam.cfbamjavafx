// Description: Java 25 JavaFX Add Pane implementation for SchemaTweak.
...
/**
 *	CFBamJavaFXSchemaTweakAddPane JavaFX Add Pane implementation
 *	for SchemaTweak.
 */
public class CFBamJavaFXSchemaTweakAddPane
extends CFSplitPane
implements ICFBamJavaFXSchemaTweakPaneCommon
{
	...
	public CFBamJavaFXSchemaTweakAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaTweakObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaTweakPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
