// Description: Java 25 JavaFX Attribute Pane implementation for DateType.
...
implements ICFBamJavaFXDateTypePaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DateDef.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 4 );
			setFieldNameInzTag( "cfbam.javafx.DateDef.AttrPane.Dummy.EffLabel" );
		}
	}
