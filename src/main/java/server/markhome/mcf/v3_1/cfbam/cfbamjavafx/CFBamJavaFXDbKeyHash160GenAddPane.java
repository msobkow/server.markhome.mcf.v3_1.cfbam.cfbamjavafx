// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash160Gen.
...
/**
 *	CFBamJavaFXDbKeyHash160GenAddPane JavaFX Add Pane implementation
 *	for DbKeyHash160Gen.
 */
public class CFBamJavaFXDbKeyHash160GenAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash160GenPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash160GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
