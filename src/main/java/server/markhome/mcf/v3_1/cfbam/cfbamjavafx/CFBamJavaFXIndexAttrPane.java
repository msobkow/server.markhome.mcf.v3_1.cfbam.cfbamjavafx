// Description: Java 25 JavaFX Attribute Pane implementation for Index.
...
implements ICFBamJavaFXIndexPaneCommon
{
		...
		extends CFLabel
	{
		public DefSchemaCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.LookupDefSchema.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public DefSchemaCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.DefSchema.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortNameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.ShortName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortNameEditor() {
			super();
			setMaxLen( 16 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.ShortName.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public LabelCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.Label.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public LabelEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.Label.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ShortDescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.ShortDescription.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ShortDescriptionEditor() {
			super();
			setMaxLen( 128 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.ShortDescription.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 1023 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.Description.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DbNameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.DbName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DbNameEditor() {
			super();
			setMaxLen( 32 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.DbName.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SuffixCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.Suffix.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public SuffixEditor() {
			super();
			setMaxLen( 16 );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.Suffix.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsUniqueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.IsUnique.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsUniqueEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.IsUnique.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsDbMappedCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.IsDbMapped.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsDbMappedEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfbam.javafx.Index.AttrPane.IsDbMapped.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public CodeVisCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.Index.AttrPane.CodeVis.EffLabel"));
		}
	}
