// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash160Gen.
...
/**
 *	CFBamJavaFXDbKeyHash160GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash160Gen.
 */
public class CFBamJavaFXDbKeyHash160GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash160GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash160Gen";
	...
	public CFBamJavaFXDbKeyHash160GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash160Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash160GenObj obj = getJavaFXFocusAsDbKeyHash160Gen();
					ICFBamDbKeyHash160GenEditObj editObj = (ICFBamDbKeyHash160GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash160GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash160Gen( ICFBamDbKeyHash160GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash160GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash160GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
