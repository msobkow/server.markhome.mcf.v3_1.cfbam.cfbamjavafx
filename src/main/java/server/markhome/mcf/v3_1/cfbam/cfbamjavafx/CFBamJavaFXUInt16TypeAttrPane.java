// Description: Java 25 JavaFX Attribute Pane implementation for UInt16Type.
...
implements ICFBamJavaFXUInt16TypePaneCommon
{
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt16Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFUInt16Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( ICFBamUInt16Def.INITVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt16Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MinValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt16Def.AttrPane.MinValue.EffLabel"));
		}
	}
		...
		extends CFUInt16Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( ICFBamUInt16Def.MINVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt16Def.AttrPane.MinValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public MaxValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.UInt16Def.AttrPane.MaxValue.EffLabel"));
		}
	}
		...
		extends CFUInt16Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( ICFBamUInt16Def.MAXVALUE_MIN_VALUE );
			setFieldNameInzTag( "cfbam.javafx.UInt16Def.AttrPane.MaxValue.EffLabel" );
		}
	}
