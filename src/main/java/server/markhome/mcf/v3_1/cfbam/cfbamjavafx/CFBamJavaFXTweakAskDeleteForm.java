// Description: Java 25 JavaFX Ask Delete Pane implementation for Tweak.
...
/**
 *	CFBamJavaFXTweakAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Tweak.
 */
public class CFBamJavaFXTweakAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTweakPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tweak";
	...
	public CFBamJavaFXTweakAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTweakObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tweak?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTweakObj obj = getJavaFXFocusAsTweak();
					ICFBamTweakEditObj editObj = (ICFBamTweakEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTweakFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTweak( ICFBamTweakObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTweakPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTweakPaneCommon)attrPane).setPaneMode( value );
		}
	}
