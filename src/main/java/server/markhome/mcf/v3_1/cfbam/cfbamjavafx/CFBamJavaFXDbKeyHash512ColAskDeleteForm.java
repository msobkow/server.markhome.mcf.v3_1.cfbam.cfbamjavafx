// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash512Col.
...
/**
 *	CFBamJavaFXDbKeyHash512ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash512Col.
 */
public class CFBamJavaFXDbKeyHash512ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash512Col";
	...
	public CFBamJavaFXDbKeyHash512ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash512Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash512ColObj obj = getJavaFXFocusAsDbKeyHash512Col();
					ICFBamDbKeyHash512ColEditObj editObj = (ICFBamDbKeyHash512ColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash512ColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash512Col( ICFBamDbKeyHash512ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
