// Description: Java 25 JavaFX View/Edit Form implementation for DbKeyHash512Type.
...
/**
 *	CFBamJavaFXDbKeyHash512TypeViewEditForm JavaFX View/Edit Form implementation
 *	for DbKeyHash512Type.
 */
public class CFBamJavaFXDbKeyHash512TypeViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DbKeyHash512Type";
	...
	public CFBamJavaFXDbKeyHash512TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDbKeyHash512TypeObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getDbKeyHash512TypeFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamDbKeyHash512TypeObj focus = getJavaFXFocusAsDbKeyHash512Type();
		if( focus != null ) {
			ICFBamDbKeyHash512TypeEditObj editObj = (ICFBamDbKeyHash512TypeEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamDbKeyHash512TypeObj argFocus = (ICFBamDbKeyHash512TypeObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDbKeyHash512TypeObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDbKeyHash512Type() != null ) {
							if( null == getJavaFXFocusAsDbKeyHash512Type().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsDbKeyHash512Type();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
