// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash384Col.
...
/**
 *	CFBamJavaFXDbKeyHash384ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash384Col.
 */
public class CFBamJavaFXDbKeyHash384ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash384Col";
	...
	public CFBamJavaFXDbKeyHash384ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash384Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash384ColObj obj = getJavaFXFocusAsDbKeyHash384Col();
					ICFBamDbKeyHash384ColEditObj editObj = (ICFBamDbKeyHash384ColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash384ColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash384Col( ICFBamDbKeyHash384ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash384ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash384ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
