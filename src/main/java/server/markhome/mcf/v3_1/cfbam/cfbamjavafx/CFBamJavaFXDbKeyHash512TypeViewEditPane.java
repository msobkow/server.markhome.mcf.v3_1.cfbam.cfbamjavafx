// Description: Java 25 JavaFX View/Edit Pane implementation for DbKeyHash512Type.
...
/**
 *	CFBamJavaFXDbKeyHash512TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for DbKeyHash512Type.
 */
public class CFBamJavaFXDbKeyHash512TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash512TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512TypeObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getDbKeyHash512TypeFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
