// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash512Gen.
...
/**
 *	CFBamJavaFXDbKeyHash512GenAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash512Gen.
 */
public class CFBamJavaFXDbKeyHash512GenAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash512GenPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash512GenObj cur = getJavaFXFocusAsDbKeyHash512Gen();
				if( cur != null ) {
					ICFBamDbKeyHash512GenEditObj editObj = (ICFBamDbKeyHash512GenEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash512GenObj focus = getEffJavaFXFocus();
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash512Def.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 128 );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash512Def.AttrPane.InitValue.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SliceCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash512Gen.AttrPane.Slice.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public SliceEditor() {
			super();
			setMinValue( ICFBamDbKeyHash512Gen.SLICE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash512Gen.SLICE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash512Gen.AttrPane.Slice.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public BlockSizeCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.DbKeyHash512Gen.AttrPane.BlockSize.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public BlockSizeEditor() {
			super();
			setMinValue( ICFBamDbKeyHash512Gen.BLOCKSIZE_MIN_VALUE );
			setMaxValue( ICFBamDbKeyHash512Gen.BLOCKSIZE_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.DbKeyHash512Gen.AttrPane.BlockSize.EffLabel" );
		}
	}
	...
	public CFBamJavaFXDbKeyHash512GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsDbKeyHash512Gen( argFocus );
	...
	public ICFBamDbKeyHash512GenObj getEffJavaFXFocus() {
		ICFBamDbKeyHash512GenObj eff = (ICFBamDbKeyHash512GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash512GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash512GenObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash512GenObj focus = getJavaFXFocusAsDbKeyHash512Gen();
		ICFBamDbKeyHash512GenEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash512GenEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash512GenEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash512GenObj)editObj.create();
