// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash512Col.
...
/**
 *	CFBamJavaFXDbKeyHash512ColEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash512Col.
 */
public class CFBamJavaFXDbKeyHash512ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash512ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash512ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash512ColObj focus = (ICFBamDbKeyHash512ColObj)getJavaFXFocusAsDbKeyHash512Col();
			if( focus != null ) {
