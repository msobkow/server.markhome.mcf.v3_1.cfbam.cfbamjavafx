// Description: Java 25 JavaFX List of Obj Pane implementation for Atom.
...
implements ICFBamJavaFXAtomPaneList
{
	...
	protected TableColumn<ICFBamAtomObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamAtomObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamAtomObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamAtomObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamAtomObj,CFLibDbKeyHash256>,TableCell<ICFBamAtomObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamAtomObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamAtomObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamAtomObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamAtom.CLASS_CODE ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamAtom.CLASS_CODE ) {
								...
								ICFBamDbKeyHash384DefObj obj = (ICFBamDbKeyHash384DefObj)selectedInstance;
								CFBorderPane frame = javafxSchema.getDbKeyHash384DefFactory().newViewEditForm( cfFormManager, obj, getViewEditClosedCallback(), false );
								((ICFBamJavaFXDbKeyHash384DefPaneCommon)frame).setPaneMode( CFPane.PaneMode.Edit );
								cfFormManager.pushForm( frame );
							}
							else if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash384Col.CLASS_CODE ) {
								ICFBamDbKeyHash384ColObj obj = (ICFBamDbKeyHash384ColObj)selectedInstance;
								...
								ICFBamDbKeyHash512DefObj obj = (ICFBamDbKeyHash512DefObj)selectedInstance;
								CFBorderPane frame = javafxSchema.getDbKeyHash512DefFactory().newViewEditForm( cfFormManager, obj, getViewEditClosedCallback(), false );
								((ICFBamJavaFXDbKeyHash512DefPaneCommon)frame).setPaneMode( CFPane.PaneMode.Edit );
								cfFormManager.pushForm( frame );
							}
							else if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamDbKeyHash512Col.CLASS_CODE ) {
								ICFBamDbKeyHash512ColObj obj = (ICFBamDbKeyHash512ColObj)selectedInstance;
