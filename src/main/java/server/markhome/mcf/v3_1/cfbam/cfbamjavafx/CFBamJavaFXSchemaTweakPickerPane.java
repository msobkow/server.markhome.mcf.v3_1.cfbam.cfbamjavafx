// Description: Java 25 JavaFX Picker of Obj Pane implementation for SchemaTweak.
...
/**
 *	CFBamJavaFXSchemaTweakPickerPane JavaFX Pick Obj Pane implementation
 *	for SchemaTweak.
 */
public class CFBamJavaFXSchemaTweakPickerPane
extends CFBorderPane
implements ICFBamJavaFXSchemaTweakPaneList
{
	public static String S_FormName = "Choose SchemaTweak";
	...
	protected ICFBamJavaFXSchemaTweakChosen invokeWhenChosen = null;
	protected ICFBamSchemaDefObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXSchemaTweakPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSchemaTweak( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSchemaTweak( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
