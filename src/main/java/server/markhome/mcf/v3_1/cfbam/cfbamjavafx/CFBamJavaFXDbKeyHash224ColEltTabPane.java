// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash224Col.
...
/**
 *	CFBamJavaFXDbKeyHash224ColEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash224Col.
 */
public class CFBamJavaFXDbKeyHash224ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash224ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash224ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash224ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash224ColObj focus = (ICFBamDbKeyHash224ColObj)getJavaFXFocusAsDbKeyHash224Col();
			if( focus != null ) {
