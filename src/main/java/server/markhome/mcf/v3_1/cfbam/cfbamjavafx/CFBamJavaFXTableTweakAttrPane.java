// Description: Java 25 JavaFX Attribute Pane implementation for TableTweak.
...
/**
 *	CFBamJavaFXTableTweakAttrPane JavaFX Attribute Pane implementation
 *	for TableTweak.
 */
public class CFBamJavaFXTableTweakAttrPane
extends CFGridPane
implements ICFBamJavaFXTableTweakPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamTableTweakObj cur = getJavaFXFocusAsTableTweak();
				if( cur != null ) {
					ICFBamTableTweakEditObj editObj = (ICFBamTableTweakEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamTableTweakObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXTableTweakAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableTweakObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsTableTweak( argFocus );
	...
	public ICFBamTableTweakObj getEffJavaFXFocus() {
		ICFBamTableTweakObj eff = (ICFBamTableTweakObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamTableTweakObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamTableTweakObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamTableTweakObj focus = getJavaFXFocusAsTableTweak();
		ICFBamTableTweakEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamTableTweakEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamTableTweakEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamTableTweakObj)editObj.create();
