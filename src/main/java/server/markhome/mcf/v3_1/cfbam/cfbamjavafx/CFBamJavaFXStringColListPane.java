// Description: Java 25 JavaFX List of Obj Pane implementation for StringCol.
...
implements ICFBamJavaFXStringColPaneList
{
	...
	protected TableColumn<ICFBamStringColObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamStringColObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamStringColObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamStringColObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamStringColObj,CFLibDbKeyHash256>,TableCell<ICFBamStringColObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamStringColObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamStringColObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamStringColObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamStringCol.CLASS_CODE ) {
