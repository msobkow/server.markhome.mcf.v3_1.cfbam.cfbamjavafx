// Description: Java 25 JavaFX Attribute Pane implementation for DbKeyHash128Col.
...
/**
 *	CFBamJavaFXDbKeyHash128ColAttrPane JavaFX Attribute Pane implementation
 *	for DbKeyHash128Col.
 */
public class CFBamJavaFXDbKeyHash128ColAttrPane
extends CFGridPane
implements ICFBamJavaFXDbKeyHash128ColPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamDbKeyHash128ColObj cur = getJavaFXFocusAsDbKeyHash128Col();
				if( cur != null ) {
					ICFBamDbKeyHash128ColEditObj editObj = (ICFBamDbKeyHash128ColEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDbKeyHash128ColObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDbKeyHash128ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamDbKeyHash128ColObj getEffJavaFXFocus() {
		ICFBamDbKeyHash128ColObj eff = (ICFBamDbKeyHash128ColObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDbKeyHash128ColObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDbKeyHash128ColObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDbKeyHash128ColEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDbKeyHash128ColEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDbKeyHash128ColEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDbKeyHash128ColObj)editObj.create();
