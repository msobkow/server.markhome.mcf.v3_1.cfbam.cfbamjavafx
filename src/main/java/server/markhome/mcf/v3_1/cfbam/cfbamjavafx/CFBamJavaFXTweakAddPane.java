// Description: Java 25 JavaFX Add Pane implementation for Tweak.
...
/**
 *	CFBamJavaFXTweakAddPane JavaFX Add Pane implementation
 *	for Tweak.
 */
public class CFBamJavaFXTweakAddPane
extends CFSplitPane
implements ICFBamJavaFXTweakPaneCommon
{
	...
	public CFBamJavaFXTweakAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTweakObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTweakPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
