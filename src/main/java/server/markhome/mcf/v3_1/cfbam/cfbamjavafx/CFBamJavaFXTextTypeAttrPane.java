// Description: Java 25 JavaFX Attribute Pane implementation for TextType.
...
implements ICFBamJavaFXTextTypePaneCommon
{
		...
		extends CFLabel
	{
		public MaxLenCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TextDef.AttrPane.MaxLen.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public MaxLenEditor() {
			super();
			setMinValue( ICFBamTextDef.MAXLEN_MIN_VALUE );
			setMaxValue( ICFBamTextDef.MAXLEN_MAX_VALUE );
			setFieldNameInzTag( "cfbam.javafx.TextDef.AttrPane.MaxLen.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public InitValueCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TextDef.AttrPane.InitValue.EffLabel"));
		}
	}
		...
		extends CFTextEditor
	{
		public InitValueEditor() {
			super();
			setMaxLen( 65535 );
			setFieldNameInzTag( "cfbam.javafx.TextDef.AttrPane.InitValue.EffLabel" );
			setPrefHeight( 10 * 20 );
			setMinHeight( 10 * 20 );
		}
	}
		...
		extends CFLabel
	{
		public XmlElementNameCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TextDef.AttrPane.XmlElementName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public XmlElementNameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfbam.javafx.TextDef.AttrPane.XmlElementName.EffLabel" );
		}
	}
