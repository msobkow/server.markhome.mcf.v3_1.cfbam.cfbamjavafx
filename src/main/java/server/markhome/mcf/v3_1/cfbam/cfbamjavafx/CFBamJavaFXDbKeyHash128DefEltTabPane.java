// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash128Def.
...
/**
 *	CFBamJavaFXDbKeyHash128DefEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash128Def.
 */
public class CFBamJavaFXDbKeyHash128DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash128DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash128DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash128DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash128DefObj focus = (ICFBamDbKeyHash128DefObj)getJavaFXFocusAsDbKeyHash128Def();
			if( focus != null ) {
