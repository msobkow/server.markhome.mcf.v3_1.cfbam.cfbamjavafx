// Description: Java 25 JavaFX Attribute Pane implementation for TZDateType.
...
implements ICFBamJavaFXTZDateTypePaneCommon
{
		...
		extends CFLabel
	{
		public DummyCFLabel() {
			super();
			setText(Inz.s("cfbam.javafx.TZDateDef.AttrPane.Dummy.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DummyEditor() {
			super();
			setMaxLen( 4 );
			setFieldNameInzTag( "cfbam.javafx.TZDateDef.AttrPane.Dummy.EffLabel" );
		}
	}
