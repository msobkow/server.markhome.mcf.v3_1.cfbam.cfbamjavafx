// Description: Java 25 JavaFX Add Form implementation for DbKeyHash256Gen.
...
/**
 *	CFBamJavaFXDbKeyHash256GenAddForm JavaFX Add Form implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamJavaFXDbKeyHash256GenAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash256GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash256Gen";
	...
	public CFBamJavaFXDbKeyHash256GenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256GenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash256GenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash256GenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash256GenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash256GenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash256GenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
