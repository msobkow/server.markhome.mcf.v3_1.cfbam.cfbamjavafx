// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash256Col.
...
/**
 *	CFBamJavaFXDbKeyHash256ColEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash256Col.
 */
public class CFBamJavaFXDbKeyHash256ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash256ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash256ColObj focus = (ICFBamDbKeyHash256ColObj)getJavaFXFocusAsDbKeyHash256Col();
			if( focus != null ) {
