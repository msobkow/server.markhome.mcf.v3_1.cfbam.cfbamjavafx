// Description: Java 25 JavaFX Add Form implementation for DbKeyHash384Gen.
...
/**
 *	CFBamJavaFXDbKeyHash384GenAddForm JavaFX Add Form implementation
 *	for DbKeyHash384Gen.
 */
public class CFBamJavaFXDbKeyHash384GenAddForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash384GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DbKeyHash384Gen";
	...
	public CFBamJavaFXDbKeyHash384GenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384GenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDbKeyHash384GenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDbKeyHash384GenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDbKeyHash384GenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash384GenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDbKeyHash384GenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
