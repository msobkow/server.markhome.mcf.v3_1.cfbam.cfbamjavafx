// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash384Type.
...
/**
 *	CFBamJavaFXDbKeyHash384TypeEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash384Type.
 */
public class CFBamJavaFXDbKeyHash384TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash384TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash384TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash384TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash384TypeObj focus = (ICFBamDbKeyHash384TypeObj)getJavaFXFocusAsDbKeyHash384Type();
			if( focus != null ) {
