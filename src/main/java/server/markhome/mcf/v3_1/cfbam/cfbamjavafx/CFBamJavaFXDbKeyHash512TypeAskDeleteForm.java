// Description: Java 25 JavaFX Ask Delete Pane implementation for DbKeyHash512Type.
...
/**
 *	CFBamJavaFXDbKeyHash512TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DbKeyHash512Type.
 */
public class CFBamJavaFXDbKeyHash512TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDbKeyHash512TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DbKeyHash512Type";
	...
	public CFBamJavaFXDbKeyHash512TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash512TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DbKeyHash512Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDbKeyHash512TypeObj obj = getJavaFXFocusAsDbKeyHash512Type();
					ICFBamDbKeyHash512TypeEditObj editObj = (ICFBamDbKeyHash512TypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDbKeyHash512TypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDbKeyHash512Type( ICFBamDbKeyHash512TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDbKeyHash512TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
