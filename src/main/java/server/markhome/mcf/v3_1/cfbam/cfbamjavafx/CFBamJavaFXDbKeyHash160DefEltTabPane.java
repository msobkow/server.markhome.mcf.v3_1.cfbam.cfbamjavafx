// Description: Java 25 JavaFX Element TabPane implementation for DbKeyHash160Def.
...
/**
 *	CFBamJavaFXDbKeyHash160DefEltTabPane JavaFX Element TabPane implementation
 *	for DbKeyHash160Def.
 */
public class CFBamJavaFXDbKeyHash160DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDbKeyHash160DefPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDbKeyHash160DefObj focus = (ICFBamDbKeyHash160DefObj)getJavaFXFocusAsDbKeyHash160Def();
			if( focus != null ) {
