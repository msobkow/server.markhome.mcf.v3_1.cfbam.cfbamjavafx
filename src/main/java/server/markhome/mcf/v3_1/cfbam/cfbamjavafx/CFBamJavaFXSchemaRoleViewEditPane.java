// Description: Java 25 JavaFX View/Edit Pane implementation for SchemaRole.
...
/**
 *	CFBamJavaFXSchemaRoleViewEditPane JavaFX View/Edit Pane implementation
 *	for SchemaRole.
 */
public class CFBamJavaFXSchemaRoleViewEditPane
extends CFSplitPane
implements ICFBamJavaFXSchemaRolePaneCommon
{
	...
	public CFBamJavaFXSchemaRoleViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRoleObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaRolePaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
