// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash160Col.
...
/**
 *	CFBamJavaFXDbKeyHash160ColAddPane JavaFX Add Pane implementation
 *	for DbKeyHash160Col.
 */
public class CFBamJavaFXDbKeyHash160ColAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash160ColPaneCommon
{
	...
	public CFBamJavaFXDbKeyHash160ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash160ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash160ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
