// Description: Java 25 JavaFX Add Pane implementation for DbKeyHash256Type.
...
/**
 *	CFBamJavaFXDbKeyHash256TypeAddPane JavaFX Add Pane implementation
 *	for DbKeyHash256Type.
 */
public class CFBamJavaFXDbKeyHash256TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXDbKeyHash256TypePaneCommon
{
	...
	public CFBamJavaFXDbKeyHash256TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDbKeyHash256TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDbKeyHash256TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
