// Description: Java 25 JavaFX List of Obj Pane implementation for BlobDef.
...
implements ICFBamJavaFXBlobDefPaneList
{
	...
	protected TableColumn<ICFBamBlobDefObj, CFLibDbKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamBlobDefObj,CFLibDbKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamBlobDefObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFBamBlobDefObj, CFLibDbKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamBlobDefObj,CFLibDbKeyHash256>,TableCell<ICFBamBlobDefObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFBamBlobDefObj,CFLibDbKeyHash256> call(
				TableColumn<ICFBamBlobDefObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamBlobDefObj>();
			}
		});
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFBam") && backingClassCode == ICFBamBlobDef.CLASS_CODE ) {
